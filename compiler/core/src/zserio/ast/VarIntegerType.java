...
public class VarIntegerType extends IntegerType
{
    ...
    public static final BigInteger VARUINT16_UPPER_BOUND = BigInteger.ONE.shiftLeft(15).subtract(BigInteger.ONE); 
    ...
    public static final BigInteger VARUINT32_UPPER_BOUND = BigInteger.ONE.shiftLeft(29).subtract(BigInteger.ONE); 
    ...
    public static final BigInteger VARUINT64_UPPER_BOUND = BigInteger.ONE.shiftLeft(57).subtract(BigInteger.ONE); 
