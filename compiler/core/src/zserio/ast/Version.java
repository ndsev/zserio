...
/**
 * Class which represents the zserio version number and provides its comparison.
 * Also implements version number parsing.
 */
public class Version implements Comparable<Version>
{
     ...
     */
    public Version(int major, int minor, int revision, Integer preRelease)
    {
        this.major = major;
        this.minor = minor;
