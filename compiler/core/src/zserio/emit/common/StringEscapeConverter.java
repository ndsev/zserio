 ...
 *
 * This is currently used for C++ emitter (converts problematic unicode escape sequences to hexadecimal) and
 * for Java emitter (converts not supported hexadecimal sequences to unicode).
 */
