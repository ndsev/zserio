...
public class ZserioParserTest
{
    ...
    {
        checkParseTree("importDeclaration", "import pkg.*;", "(importDeclaration import (id pkg) . * ;)");
        checkParseTree(
                "importDeclaration", "import pkg1.pkg2;", "(importDeclaration import (id pkg1) . (id pkg2) ;)");
    ...
    {
        checkParseTree(
                "templateParameters", "<TYPE1, TYPE2>", "(templateParameters < (id TYPE1) , (id TYPE2) >)");
    }
    ...
    {
        checkParseTree(
                "fieldAlignment", "align(15):", "(fieldAlignment align ( (expression (literal 15)) ) :)");
    }

    @Test
    public void fieldOffset()
    {
        checkParseTree("fieldOffset", "10:", "(fieldOffset (expression (literal 10)) :)");
        checkParseTree("fieldOffset", "id1:", "(fieldOffset (expression (id id1)) :)");
        checkParseTree(
                "fieldOffset", "id1.id2:", "(fieldOffset (expression (expression (id id1)) . (id id2)) :)");
    ...
    {
        checkParseTree("fieldInitializer", "= 12", "(fieldInitializer = (expression (literal 12)))");
        checkParseTree(
                "fieldInitializer", "= \"string\"", "(fieldInitializer = (expression (literal \"string\")))");
    }
    ...
    public void functionDefinition()
    {
        ...
        assertParseError(
                "functionDefinition", "function Parameterized() testFunc() { return 0; }", "missing ID at '('");
