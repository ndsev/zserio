...
{
public:
    explicit PositivenessProvider(::zserio::IPubSubClient& pubSubClient);
    ~PositivenessProvider() = default;

    PositivenessProvider(const PositivenessProvider&) = default;
    PositivenessProvider& operator=(const PositivenessProvider&) = default;

    PositivenessProvider(PositivenessProvider&&) = default;
    PositivenessProvider& operator=(PositivenessProvider&&) = default;

    void publishPositiveness(::pubsub_poc::BoolValue& object, void* context = nullptr) const;
