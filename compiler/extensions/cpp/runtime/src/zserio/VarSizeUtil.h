...
namespace zserio
{
    ...
    /**
     * Converts string size of type size_t to uint32_t value.
     *
     * \param value String size of type size_t to convert.
     *
     * \return uint32_t uint32_t value converted from string size.
     *
     * \throw CppRuntimeException when input value is not convertible to uint32_t value.
     */
