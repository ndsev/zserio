...
const ::zserio::ITypeInfo& ReflectableBitmask::typeInfo()
{
    ...
    static const ::zserio::BitmaskTypeInfo<allocator_type> typeInfo = {
        ::zserio::makeStringView("test_object.ReflectableBitmask"),
...
::zserio::IReflectablePtr ReflectableBitmask::reflectable(const ::std::allocator<uint8_t>& allocator) const
{
    ...
    {
    public:
        explicit Reflectable(::test_object::ReflectableBitmask bitmask) :
                ::zserio::ReflectableBase<::std::allocator<uint8_t>>(::test_object::ReflectableBitmask::typeInfo()),
                m_bitmask(bitmask)
        {}
    ...
    private:
        ::test_object::ReflectableBitmask m_bitmask;
    };
...
{
    contextNode.getContext().init(::zserio::StdIntArrayTraits<::test_object::ReflectableBitmask::underlying_type>(),
            m_value);
}
...
size_t ReflectableBitmask::bitSizeOf(::zserio::PackingContextNode& contextNode, size_t) const
{
    return contextNode.getContext().bitSizeOf(
            ::zserio::StdIntArrayTraits<::test_object::ReflectableBitmask::underlying_type>(),
            m_value);
}
        ...
        ::zserio::BitStreamReader& in)
{
    return contextNode.getContext().read(
            ::zserio::StdIntArrayTraits<::test_object::ReflectableBitmask::underlying_type>(), in);
}
