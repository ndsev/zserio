...
const ::zserio::ITypeInfo& ReflectableObject::typeInfo()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<allocator_type>, 2> fields = {
        ...
        ::zserio::BasicFieldInfo<allocator_type>{
            ...
            ::test_object::ReflectableNested::typeInfo(), // typeInfo
    ...
    static const ::zserio::StructTypeInfo<allocator_type> typeInfo = {
        ::zserio::makeStringView("test_object.ReflectableObject"),
...
::zserio::IReflectableConstPtr ReflectableObject::reflectable(const allocator_type& allocator) const
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::ReflectableObject& object, const allocator_type& allocator) :
                ::zserio::ReflectableConstAllocatorHolderBase<allocator_type>(::test_object::ReflectableObject::typeInfo(), allocator),
                m_object(object)
        {}
    ...
    private:
        const ::test_object::ReflectableObject& m_object;
    };
...
::zserio::IReflectablePtr ReflectableObject::reflectable(const allocator_type& allocator)
{
    ...
    {
    public:
        explicit Reflectable(::test_object::ReflectableObject& object, const allocator_type& allocator) :
                ::zserio::ReflectableAllocatorHolderBase<allocator_type>(::test_object::ReflectableObject::typeInfo(), allocator),
                m_object(object)
        {}
                ...
                const ::zserio::AnyHolder<allocator_type>& value) override
        {
            ...
            if (name == ::zserio::makeStringView("reflectableNested"))
            {
                m_object.setReflectableNested(value.get<::test_object::ReflectableNested>());
                return;
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'ReflectableObject'!";
        }
        ...
        virtual ::zserio::IReflectablePtr createField(::zserio::StringView name) override
        {
            ...
            if (name == ::zserio::makeStringView("reflectableNested"))
            {
                m_object.setReflectableNested(::test_object::ReflectableNested(get_allocator()));
                return m_object.getReflectableNested().reflectable(get_allocator());
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'ReflectableObject'!";
        }
    ...
    private:
        ::test_object::ReflectableObject& m_object;
    };
...
::test_object::ReflectableNested& ReflectableObject::getReflectableNested()
{
    return m_reflectableNested_;
}

const ::test_object::ReflectableNested& ReflectableObject::getReflectableNested() const
{
    return m_reflectableNested_;
}

void ReflectableObject::setReflectableNested(const ::test_object::ReflectableNested& reflectableNested_)
{
    m_reflectableNested_ = reflectableNested_;
}

void ReflectableObject::setReflectableNested(::test_object::ReflectableNested&& reflectableNested_)
{
...
void ReflectableObject::createPackingContext(::zserio::PackingContextNode& contextNode)
{
    ...
    ::test_object::ReflectableNested::createPackingContext(contextNode.createChild());
}
...
::test_object::ReflectableNested ReflectableObject::readReflectableNested(::zserio::BitStreamReader& in,
        const allocator_type& allocator)
{
    return ::test_object::ReflectableNested(in, static_cast<int32_t>(13), getStringField(), allocator);
}

::test_object::ReflectableNested ReflectableObject::readReflectableNested(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    return ::test_object::ReflectableNested(contextNode.getChildren().at(1), in, static_cast<int32_t>(13), getStringField(), allocator);
}
