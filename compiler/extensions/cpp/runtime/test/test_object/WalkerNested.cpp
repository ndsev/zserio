...
const ::zserio::ITypeInfo& WalkerNested::typeInfo()
{
    ...
    static const ::zserio::StructTypeInfo<allocator_type> typeInfo = {
        ::zserio::makeStringView("test_object.WalkerNested"),
...
::zserio::IReflectableConstPtr WalkerNested::reflectable(const allocator_type& allocator) const
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::WalkerNested& object, const allocator_type& allocator) :
                ::zserio::ReflectableConstAllocatorHolderBase<allocator_type>(::test_object::WalkerNested::typeInfo(), allocator),
                m_object(object)
        {}
    ...
    private:
        const ::test_object::WalkerNested& m_object;
    };
...
::zserio::IReflectablePtr WalkerNested::reflectable(const allocator_type& allocator)
{
    ...
    {
    public:
        explicit Reflectable(::test_object::WalkerNested& object, const allocator_type& allocator) :
                ::zserio::ReflectableAllocatorHolderBase<allocator_type>(::test_object::WalkerNested::typeInfo(), allocator),
                m_object(object)
        {}
    ...
    private:
        ::test_object::WalkerNested& m_object;
    };
