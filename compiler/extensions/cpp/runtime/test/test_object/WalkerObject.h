...
#ifndef TEST_OBJECT_WALKER_OBJECT_H
#define TEST_OBJECT_WALKER_OBJECT_H
...
private:
    ...
    public:
        ...
        void create(::zserio::vector<::test_object::WalkerUnion>& array,
                ::zserio::BitStreamReader& in, size_t index) const;

        void create(::zserio::PackingContextNode& contextNode,
                ::zserio::vector<::test_object::WalkerUnion>& array,
                ::zserio::BitStreamReader& in, size_t index) const;
    ...
    using ZserioArrayType_unionArray = ::zserio::Array<::zserio::vector<::test_object::WalkerUnion>, ::zserio::ObjectArrayTraits<::test_object::WalkerUnion, ZserioElementFactory_unionArray>, ::zserio::ArrayType::AUTO>;
    using ZserioArrayType_optionalUnionArray = ::zserio::Array<::zserio::vector<::test_object::WalkerUnion>, ::zserio::ObjectArrayTraits<::test_object::WalkerUnion, ZserioElementFactory_optionalUnionArray>, ::zserio::ArrayType::AUTO>;
...
public:
            ...
            WalkerObject(allocator)
    {
        ...
        m_unionArray_ = ZserioArrayType_unionArray(::std::forward<ZSERIO_T_unionArray>(unionArray_), ::zserio::ObjectArrayTraits<::test_object::WalkerUnion, ZserioElementFactory_unionArray>());
        m_optionalUnionArray_ = ::zserio::createOptionalArray<ZserioArrayType_optionalUnionArray>(::std::forward<ZSERIO_T_optionalUnionArray>(optionalUnionArray_), ::zserio::ObjectArrayTraits<::test_object::WalkerUnion, ZserioElementFactory_optionalUnionArray>());
    }
    ...
    const ::test_object::WalkerNested& getNested() const;
    ::test_object::WalkerNested& getNested();
    void setNested(const ::test_object::WalkerNested& nested_);
    void setNested(::test_object::WalkerNested&& nested_);
    ...
    const ::zserio::vector<::test_object::WalkerUnion>& getUnionArray() const;
    ::zserio::vector<::test_object::WalkerUnion>& getUnionArray();
    void setUnionArray(const ::zserio::vector<::test_object::WalkerUnion>& unionArray_);
    void setUnionArray(::zserio::vector<::test_object::WalkerUnion>&& unionArray_);

    const ::zserio::vector<::test_object::WalkerUnion>& getOptionalUnionArray() const;
    ::zserio::vector<::test_object::WalkerUnion>& getOptionalUnionArray();
    void setOptionalUnionArray(const ::zserio::vector<::test_object::WalkerUnion>& optionalUnionArray_);
    void setOptionalUnionArray(::zserio::vector<::test_object::WalkerUnion>&& optionalUnionArray_);
...
private:
    ...
    ::zserio::InplaceOptionalHolder<::test_object::WalkerNested> readNested(::zserio::BitStreamReader& in,
            const allocator_type& allocator);
    ::zserio::InplaceOptionalHolder<::test_object::WalkerNested> readNested(::zserio::PackingContextNode& contextNode,
    ...
    ::zserio::InplaceOptionalHolder<::test_object::WalkerNested> m_nested_;
...
#endif // TEST_OBJECT_WALKER_OBJECT_H
