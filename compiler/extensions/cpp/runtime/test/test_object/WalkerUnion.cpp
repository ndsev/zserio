...
void WalkerUnion::ZserioElementFactory_nestedArray::create(::zserio::vector<::test_object::WalkerNested>& array,
...
void WalkerUnion::ZserioElementFactory_nestedArray::create(::zserio::PackingContextNode& contextNode,
        ::zserio::vector<::test_object::WalkerNested>& array, ::zserio::BitStreamReader& in, size_t index) const
{
    (void)index;
...
const ::zserio::ITypeInfo& WalkerUnion::typeInfo()
{
    ...
    static const ::zserio::UnionTypeInfo<allocator_type> typeInfo = {
        ::zserio::makeStringView("test_object.WalkerUnion"),
...
::zserio::IReflectableConstPtr WalkerUnion::reflectable(const allocator_type& allocator) const
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::WalkerUnion& object, const allocator_type& allocator) :
                ::zserio::ReflectableConstAllocatorHolderBase<allocator_type>(::test_object::WalkerUnion::typeInfo(), allocator),
                m_object(object)
        {}
    ...
    private:
        const ::test_object::WalkerUnion& m_object;
    };
...
::zserio::IReflectablePtr WalkerUnion::reflectable(const allocator_type& allocator)
{
    ...
    {
    public:
        explicit Reflectable(::test_object::WalkerUnion& object, const allocator_type& allocator) :
                ::zserio::ReflectableAllocatorHolderBase<allocator_type>(::test_object::WalkerUnion::typeInfo(), allocator),
                m_object(object)
        {}
                ...
                const ::zserio::AnyHolder<allocator_type>& value) override
        {
            ...
            if (name == ::zserio::makeStringView("nestedArray"))
            {
                m_object.setNestedArray(value.get<::zserio::vector<::test_object::WalkerNested>>());
                return;
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'WalkerUnion'!";
        }
        ...
        virtual ::zserio::IReflectablePtr createField(::zserio::StringView name) override
        {
            ...
            if (name == ::zserio::makeStringView("nestedArray"))
            {
                m_object.setNestedArray(::zserio::vector<::test_object::WalkerNested>(get_allocator()));
                return ::zserio::ReflectableFactory::getCompoundArray(m_object.getNestedArray(), get_allocator());
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'WalkerUnion'!";
        }
    ...
    private:
        ::test_object::WalkerUnion& m_object;
    };
...
::zserio::vector<::test_object::WalkerNested>& WalkerUnion::getNestedArray()
{
    return m_objectChoice.get<ZserioArrayType_nestedArray>().getRawArray();
}

const ::zserio::vector<::test_object::WalkerNested>& WalkerUnion::getNestedArray() const
{
    return m_objectChoice.get<ZserioArrayType_nestedArray>().getRawArray();
}

void WalkerUnion::setNestedArray(const ::zserio::vector<::test_object::WalkerNested>& nestedArray_)
{
    m_choiceTag = CHOICE_nestedArray;
    m_objectChoice = ZserioArrayType_nestedArray(nestedArray_, ::zserio::ObjectArrayTraits<::test_object::WalkerNested, ZserioElementFactory_nestedArray>());
}

void WalkerUnion::setNestedArray(::zserio::vector<::test_object::WalkerNested>&& nestedArray_)
{
    m_choiceTag = CHOICE_nestedArray;
    m_objectChoice = ZserioArrayType_nestedArray(std::move(nestedArray_), ::zserio::ObjectArrayTraits<::test_object::WalkerNested, ZserioElementFactory_nestedArray>());
}
...
::zserio::AnyHolder<> WalkerUnion::readObject(::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    ...
    case CHOICE_nestedArray:
        {
            ZserioArrayType_nestedArray readField(::zserio::ObjectArrayTraits<::test_object::WalkerNested, ZserioElementFactory_nestedArray>(), allocator);
