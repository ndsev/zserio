...
#ifndef TEST_OBJECT_WALKER_UNION_H
#define TEST_OBJECT_WALKER_UNION_H
...
private:
    ...
    public:
        ...
        void create(::zserio::vector<::test_object::WalkerNested>& array,
                ::zserio::BitStreamReader& in, size_t index) const;

        void create(::zserio::PackingContextNode& contextNode,
                ::zserio::vector<::test_object::WalkerNested>& array,
                ::zserio::BitStreamReader& in, size_t index) const;
    ...
    using ZserioArrayType_nestedArray = ::zserio::Array<::zserio::vector<::test_object::WalkerNested>, ::zserio::ObjectArrayTraits<::test_object::WalkerNested, ZserioElementFactory_nestedArray>, ::zserio::ArrayType::AUTO>;
...
public:
    ...
    const ::zserio::vector<::test_object::WalkerNested>& getNestedArray() const;
    ::zserio::vector<::test_object::WalkerNested>& getNestedArray();
    void setNestedArray(const ::zserio::vector<::test_object::WalkerNested>& nestedArray_);
    void setNestedArray(::zserio::vector<::test_object::WalkerNested>&& nestedArray_);
...
#endif // TEST_OBJECT_WALKER_UNION_H
