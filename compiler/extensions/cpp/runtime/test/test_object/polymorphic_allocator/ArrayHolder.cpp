...
#include <test_object/polymorphic_allocator/ArrayHolder.h>
...
const ::zserio::pmr::ITypeInfo& ArrayHolder::typeInfo()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<allocator_type>, 4> fields = {
        ::zserio::BasicFieldInfo<allocator_type>{
            ...
            ::zserio::enumTypeInfo<::test_object::polymorphic_allocator::ArrayEnum, allocator_type>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<allocator_type>{
            ...
            ::test_object::polymorphic_allocator::ArrayBitmask::typeInfo(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<allocator_type>{
            ...
            ::test_object::polymorphic_allocator::ArrayObject::typeInfo(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<allocator_type>{
            ...
            ::test_object::polymorphic_allocator::ArrayParamObject::typeInfo(), // typeInfo
    ...
    static const ::zserio::StructTypeInfo<allocator_type> typeInfo = {
        ::zserio::makeStringView("test_object.polymorphic_allocator.ArrayHolder"),
...
::zserio::pmr::IReflectableConstPtr ArrayHolder::reflectable(const allocator_type& allocator) const
{
    ...
    public:
        ...
        ::zserio::pmr::IReflectableConstPtr getField(::zserio::StringView name) const override
        {
            ...
            {
                return ::zserio::pmr::ReflectableFactory::getEnumArray(m_object.getEnumArray(), get_allocator());
            }
            if (name == ::zserio::makeStringView("bitmaskArray"))
            {
                return ::zserio::pmr::ReflectableFactory::getBitmaskArray(m_object.getBitmaskArray(), get_allocator());
            }
            if (name == ::zserio::makeStringView("packedArray"))
            {
                return ::zserio::pmr::ReflectableFactory::getCompoundArray(m_object.getPackedArray(), get_allocator());
            }
            if (name == ::zserio::makeStringView("packedParamArray"))
            {
                return ::zserio::pmr::ReflectableFactory::getCompoundArray(m_object.getPackedParamArray(), get_allocator());
            }
...
::zserio::pmr::IReflectablePtr ArrayHolder::reflectable(const allocator_type& allocator)
{
    ...
    public:
                ...
                const ::zserio::AnyHolder<allocator_type>& value) override
        {
            if (name == ::zserio::makeStringView("enumArray"))
            {
                m_object.setEnumArray(value.get<::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayEnum>>());
                return;
            }
            if (name == ::zserio::makeStringView("bitmaskArray"))
            {
                m_object.setBitmaskArray(value.get<::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayBitmask>>());
                return;
            }
            if (name == ::zserio::makeStringView("packedArray"))
            {
                m_object.setPackedArray(value.get<::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayObject>>());
                return;
            }
            if (name == ::zserio::makeStringView("packedParamArray"))
            {
                m_object.setPackedParamArray(value.get<::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayParamObject>>());
                return;
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'ArrayHolder'!";
        }
        ...
        ::zserio::pmr::IReflectablePtr createField(::zserio::StringView name) override
        {
            if (name == ::zserio::makeStringView("enumArray"))
            {
                m_object.setEnumArray(::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayEnum>(get_allocator()));
                return ::zserio::pmr::ReflectableFactory::getEnumArray(m_object.getEnumArray(), get_allocator());
            }
            if (name == ::zserio::makeStringView("bitmaskArray"))
            {
                m_object.setBitmaskArray(::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayBitmask>(get_allocator()));
                return ::zserio::pmr::ReflectableFactory::getBitmaskArray(m_object.getBitmaskArray(), get_allocator());
            }
            if (name == ::zserio::makeStringView("packedArray"))
            {
                m_object.setPackedArray(::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayObject>(get_allocator()));
                return ::zserio::pmr::ReflectableFactory::getCompoundArray(m_object.getPackedArray(), get_allocator());
            }
            if (name == ::zserio::makeStringView("packedParamArray"))
            {
                m_object.setPackedParamArray(::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayParamObject>(get_allocator()));
                return ::zserio::pmr::ReflectableFactory::getCompoundArray(m_object.getPackedParamArray(), get_allocator());
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'ArrayHolder'!";
        }
...
::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayEnum>& ArrayHolder::getEnumArray()
{
    return m_enumArray_.getRawArray();
}

const ::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayEnum>& ArrayHolder::getEnumArray() const
{
    return m_enumArray_.getRawArray();
}

void ArrayHolder::setEnumArray(const ::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayEnum>& enumArray_)
{
    m_enumArray_ = ZserioArrayType_enumArray(enumArray_);
}

void ArrayHolder::setEnumArray(::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayEnum>&& enumArray_)
{
    m_enumArray_ = ZserioArrayType_enumArray(std::move(enumArray_));
}

::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayBitmask>& ArrayHolder::getBitmaskArray()
{
    return m_bitmaskArray_.getRawArray();
}

const ::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayBitmask>& ArrayHolder::getBitmaskArray() const
{
    return m_bitmaskArray_.getRawArray();
}

void ArrayHolder::setBitmaskArray(const ::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayBitmask>& bitmaskArray_)
{
    m_bitmaskArray_ = ZserioArrayType_bitmaskArray(bitmaskArray_);
}

void ArrayHolder::setBitmaskArray(::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayBitmask>&& bitmaskArray_)
{
    m_bitmaskArray_ = ZserioArrayType_bitmaskArray(std::move(bitmaskArray_));
}

::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayObject>& ArrayHolder::getPackedArray()
{
    return m_packedArray_.getRawArray();
}

const ::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayObject>& ArrayHolder::getPackedArray() const
{
    return m_packedArray_.getRawArray();
}

void ArrayHolder::setPackedArray(const ::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayObject>& packedArray_)
{
    m_packedArray_ = ZserioArrayType_packedArray(packedArray_);
}

void ArrayHolder::setPackedArray(::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayObject>&& packedArray_)
{
    m_packedArray_ = ZserioArrayType_packedArray(std::move(packedArray_));
}

::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayParamObject>& ArrayHolder::getPackedParamArray()
{
    return m_packedParamArray_.getRawArray();
}

const ::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayParamObject>& ArrayHolder::getPackedParamArray() const
{
    return m_packedParamArray_.getRawArray();
}

void ArrayHolder::setPackedParamArray(const ::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayParamObject>& packedParamArray_)
{
    m_packedParamArray_ = ZserioArrayType_packedParamArray(packedParamArray_);
}

void ArrayHolder::setPackedParamArray(::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayParamObject>&& packedParamArray_)
{
...
const ::zserio::ParsingInfo& ArrayHolder::parsingInfo() const
{
...
void ArrayHolder::ZserioElementFactory_packedArray::create(ArrayHolder&,
        ::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayObject>& array,
        ::test_object::polymorphic_allocator::ArrayObject::ZserioPackingContext& context, ::zserio::BitStreamReader& in,
        size_t)
{
...
void ArrayHolder::ZserioElementFactory_packedParamArray::create(ArrayHolder& owner,
        ::zserio::pmr::vector<::test_object::polymorphic_allocator::ArrayParamObject>& array,
        ::test_object::polymorphic_allocator::ArrayParamObject::ZserioPackingContext& context, ::zserio::BitStreamReader& in,
        size_t index)
{
