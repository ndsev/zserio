...
ArrayObject::ArrayObject(::zserio::pmr::PackingContextNode& contextNode, ::zserio::BitStreamReader& in, const allocator_type&) :
...
void ArrayObject::createPackingContext(::zserio::pmr::PackingContextNode& contextNode)
{
...
void ArrayObject::initPackingContext(::zserio::pmr::PackingContextNode& contextNode) const
{
...
size_t ArrayObject::bitSizeOf(::zserio::pmr::PackingContextNode& contextNode, size_t bitPosition) const
{
    size_t endBitPosition = bitPosition;
...
size_t ArrayObject::initializeOffsets(::zserio::pmr::PackingContextNode& contextNode, size_t bitPosition)
{
    size_t endBitPosition = bitPosition;
...
void ArrayObject::write(::zserio::pmr::PackingContextNode& contextNode, ::zserio::BitStreamWriter& out) const
{
...
uint32_t ArrayObject::readValue(::zserio::pmr::PackingContextNode& contextNode, ::zserio::BitStreamReader& in)
{
