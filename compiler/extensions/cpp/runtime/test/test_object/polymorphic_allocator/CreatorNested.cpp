...
{
    return ::zserio::read<::test_object::polymorphic_allocator::CreatorEnum>(contextNode.getChildren().at(4), in);
}
...
{
    return ::test_object::polymorphic_allocator::CreatorBitmask(contextNode.getChildren().at(5), in);
}
