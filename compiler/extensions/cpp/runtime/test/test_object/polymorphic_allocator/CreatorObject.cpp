...
::zserio::pmr::IReflectableConstPtr CreatorObject::reflectable(const allocator_type& allocator) const
{
    ...
    public:
        ...
        ::zserio::pmr::IReflectableConstPtr getField(::zserio::StringView name) const override
        {
            ...
            {
                return ::zserio::pmr::ReflectableFactory::getBuiltinArray(::zserio::BuiltinTypeInfo<allocator_type>::getString(), m_object.getTextArray(), get_allocator());
            }
            if (name == ::zserio::makeStringView("externArray"))
            {
                ...
                return ::zserio::pmr::ReflectableFactory::getBuiltinArray(::zserio::BuiltinTypeInfo<allocator_type>::getBitBuffer(), m_object.getExternArray(), get_allocator());
            }
            if (name == ::zserio::makeStringView("bytesArray"))
            {
                ...
                return ::zserio::pmr::ReflectableFactory::getBuiltinArray(::zserio::BuiltinTypeInfo<allocator_type>::getBytes(), m_object.getBytesArray(), get_allocator());
            }
...
{
    return ::test_object::polymorphic_allocator::CreatorNested(contextNode.getChildren().at(1), in, static_cast<uint32_t>(getValue()), allocator);
}
...
::zserio::InplaceOptionalHolder<::test_object::polymorphic_allocator::CreatorNested> CreatorObject::readOptionalNested(::zserio::pmr::PackingContextNode& contextNode, ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    if (in.readBool())
    {
        return ::zserio::InplaceOptionalHolder<::test_object::polymorphic_allocator::CreatorNested>(::test_object::polymorphic_allocator::CreatorNested(contextNode.getChildren().at(8), in, static_cast<uint32_t>(getValue()), allocator));
    }
