...
ReflectableNested::ReflectableNested(::zserio::pmr::PackingContextNode& contextNode, ::zserio::BitStreamReader& in,
        int32_t dummyParam_,
        ::zserio::pmr::string& stringParam_, const allocator_type&) :
        m_dummyParam_(dummyParam_),
        m_stringParam_(&stringParam_),
...
::zserio::pmr::IReflectableConstPtr ReflectableNested::reflectable(const allocator_type& allocator) const
{
    ...
    public:
        ...
        virtual ::zserio::pmr::IReflectableConstPtr callFunction(::zserio::StringView name) const override
        {
...
::zserio::pmr::IReflectablePtr ReflectableNested::reflectable(const allocator_type& allocator)
{
    ...
    public:
        ...
        virtual ::zserio::pmr::IReflectablePtr callFunction(::zserio::StringView name) override
        {
            if (name == ::zserio::makeStringView("getValue"))
            {
                return ::zserio::pmr::ReflectableFactory::getFixedUnsignedBitField(UINT8_C(31), m_object.funcGetValue(), get_allocator());
...
void ReflectableNested::createPackingContext(::zserio::pmr::PackingContextNode& contextNode)
{
...
size_t ReflectableNested::bitSizeOf(::zserio::pmr::PackingContextNode& contextNode, size_t bitPosition) const
{
    size_t endBitPosition = bitPosition;
...
size_t ReflectableNested::initializeOffsets(::zserio::pmr::PackingContextNode& contextNode, size_t bitPosition)
{
    size_t endBitPosition = bitPosition;
