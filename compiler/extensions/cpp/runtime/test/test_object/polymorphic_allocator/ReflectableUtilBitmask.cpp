...
{
    context.init<::zserio::StdIntArrayTraits<::test_object::polymorphic_allocator::ReflectableUtilBitmask::underlying_type>>(m_value);
}
...
{
    return context.bitSizeOf<::zserio::StdIntArrayTraits<::test_object::polymorphic_allocator::ReflectableUtilBitmask::underlying_type>>(m_value);
}
...
{
    context.write<::zserio::StdIntArrayTraits<::test_object::polymorphic_allocator::ReflectableUtilBitmask::underlying_type>>(out, m_value);
}
...
{
    return context.read<::zserio::StdIntArrayTraits<::test_object::polymorphic_allocator::ReflectableUtilBitmask::underlying_type>>(
            in);
}
