...
ReflectableUtilBitmask::ReflectableUtilBitmask(::zserio::pmr::PackingContextNode& contextNode, ::zserio::BitStreamReader& in) :
...
void ReflectableUtilBitmask::createPackingContext(::zserio::pmr::PackingContextNode& contextNode)
{
    contextNode.createContext();
}

void ReflectableUtilBitmask::initPackingContext(::zserio::pmr::PackingContextNode& contextNode) const
{
    contextNode.getContext().init<::zserio::StdIntArrayTraits<::test_object::polymorphic_allocator::ReflectableUtilBitmask::underlying_type>>(
            m_value);
}
...
size_t ReflectableUtilBitmask::bitSizeOf(::zserio::pmr::PackingContextNode& contextNode, size_t) const
{
    return contextNode.getContext().bitSizeOf<::zserio::StdIntArrayTraits<::test_object::polymorphic_allocator::ReflectableUtilBitmask::underlying_type>>(
            m_value);
}
...
size_t ReflectableUtilBitmask::initializeOffsets(::zserio::pmr::PackingContextNode& contextNode, size_t bitPosition) const
{
...
void ReflectableUtilBitmask::write(::zserio::pmr::PackingContextNode& contextNode, ::zserio::BitStreamWriter& out) const
{
    contextNode.getContext().write<::zserio::StdIntArrayTraits<::test_object::polymorphic_allocator::ReflectableUtilBitmask::underlying_type>>(
            out, m_value);
}
...
ReflectableUtilBitmask::underlying_type ReflectableUtilBitmask::readValue(::zserio::pmr::PackingContextNode& contextNode,
        ::zserio::BitStreamReader& in)
{
    return contextNode.getContext().read<::zserio::StdIntArrayTraits<::test_object::polymorphic_allocator::ReflectableUtilBitmask::underlying_type>>(
            in);
}
