...
ReflectableUtilChoice::ReflectableUtilChoice(::zserio::pmr::PackingContextNode& contextNode, ::zserio::BitStreamReader& in,
        uint8_t param_, const allocator_type& allocator) :
        m_param_(param_),
        m_isInitialized(true),
...
::zserio::pmr::IReflectableConstPtr ReflectableUtilChoice::reflectable(const allocator_type& allocator) const
{
    ...
    public:
        ...
        ::zserio::pmr::IReflectableConstPtr getField(::zserio::StringView name) const override
        {
            ...
            {
                return ::zserio::pmr::ReflectableFactory::getBuiltinArray(::zserio::BuiltinTypeInfo<allocator_type>::getUInt32(), m_object.getArray(), get_allocator());
            }
...
void ReflectableUtilChoice::createPackingContext(::zserio::pmr::PackingContextNode& contextNode)
{
...
void ReflectableUtilChoice::initPackingContext(::zserio::pmr::PackingContextNode&) const
{
}
...
size_t ReflectableUtilChoice::bitSizeOf(::zserio::pmr::PackingContextNode&, size_t bitPosition) const
{
    size_t endBitPosition = bitPosition;
...
size_t ReflectableUtilChoice::initializeOffsets(::zserio::pmr::PackingContextNode&, size_t bitPosition)
{
    size_t endBitPosition = bitPosition;
...
void ReflectableUtilChoice::write(::zserio::pmr::PackingContextNode&, ::zserio::BitStreamWriter& out) const
{
    switch (getParam())
    {
    case 1:
...
::zserio::pmr::AnyHolder ReflectableUtilChoice::readObject(::zserio::pmr::PackingContextNode&,
