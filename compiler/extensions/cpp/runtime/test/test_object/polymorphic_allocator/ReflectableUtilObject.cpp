...
::test_object::polymorphic_allocator::ReflectableUtilChoice ReflectableUtilObject::readReflectableUtilChoice(ReflectableUtilObject::ZserioPackingContext& context, ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    return ::test_object::polymorphic_allocator::ReflectableUtilChoice(context.getReflectableUtilChoice(), in, static_cast<uint8_t>(getChoiceParam()), allocator);
}
