...
SerializeNested::SerializeNested(::zserio::pmr::PackingContextNode& contextNode, ::zserio::BitStreamReader& in,
        int8_t param_, const allocator_type&) :
        m_param_(param_),
        m_isInitialized(true),
        m_offset_(readOffset(in)),
...
const ::zserio::pmr::ITypeInfo& SerializeNested::typeInfo()
{
    ...
    static const ::zserio::StructTypeInfo<allocator_type> typeInfo = {
        ::zserio::makeStringView("test_object.polymorphic_allocator.SerializeNested"),
...
::zserio::pmr::IReflectableConstPtr SerializeNested::reflectable(const allocator_type& allocator) const
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::polymorphic_allocator::SerializeNested& object, const allocator_type& allocator) :
                ::zserio::ReflectableConstAllocatorHolderBase<allocator_type>(::test_object::polymorphic_allocator::SerializeNested::typeInfo(), allocator),
                m_object(object)
        {}
        ...
        virtual ::zserio::pmr::IReflectableConstPtr getField(::zserio::StringView name) const override
        {
            ...
            {
                return ::zserio::pmr::ReflectableFactory::getUInt8(m_object.getOffset(), get_allocator());
            }
            if (name == ::zserio::makeStringView("optionalValue"))
            {
                ...
                return ::zserio::pmr::ReflectableFactory::getUInt32(m_object.getOptionalValue(), get_allocator());
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'SerializeNested'!";
        }

        virtual ::zserio::pmr::IReflectableConstPtr getParameter(::zserio::StringView name) const override
        {
    ...
    private:
        const ::test_object::polymorphic_allocator::SerializeNested& m_object;
    };

    return std::allocate_shared<Reflectable>(allocator, *this, allocator);
}

::zserio::pmr::IReflectablePtr SerializeNested::reflectable(const allocator_type& allocator)
{
    class Reflectable : public ::zserio::ReflectableAllocatorHolderBase<allocator_type>
    {
    public:
        explicit Reflectable(::test_object::polymorphic_allocator::SerializeNested& object, const allocator_type& allocator) :
                ::zserio::ReflectableAllocatorHolderBase<allocator_type>(::test_object::polymorphic_allocator::SerializeNested::typeInfo(), allocator),
                m_object(object)
        {}
        ...
        virtual ::zserio::pmr::IReflectablePtr getParameter(::zserio::StringView name) override
        {
            if (name == ::zserio::makeStringView("param"))
            {
                return ::zserio::pmr::ReflectableFactory::getInt8(m_object.getParam(), get_allocator());
    ...
    private:
        ::test_object::polymorphic_allocator::SerializeNested& m_object;
    };
...
void SerializeNested::createPackingContext(::zserio::pmr::PackingContextNode& contextNode)
{
    contextNode.createChild();
    contextNode.createChild().createContext();
}

void SerializeNested::initPackingContext(::zserio::pmr::PackingContextNode& contextNode) const
{
    if (getParam() >= 0)
    {
...
size_t SerializeNested::bitSizeOf(::zserio::pmr::PackingContextNode& contextNode, size_t bitPosition) const
{
    size_t endBitPosition = bitPosition;
...
size_t SerializeNested::initializeOffsets(::zserio::pmr::PackingContextNode& contextNode, size_t bitPosition)
{
    size_t endBitPosition = bitPosition;
...
void SerializeNested::write(::zserio::BitStreamWriter& out) const
{
    ...
    if (getParam() >= 0)
    {
        ...
        // check offset
        if (out.getBitPosition() / 8 != (getOffset()))
        {
...
void SerializeNested::write(::zserio::pmr::PackingContextNode& contextNode, ::zserio::BitStreamWriter& out) const
{
    out.writeBits(m_offset_, UINT8_C(8));
...
::zserio::InplaceOptionalHolder<uint32_t> SerializeNested::readOptionalValue(::zserio::BitStreamReader& in)
{
    if (getParam() >= 0)
    {
        ...
        // check offset
        if (in.getBitPosition() / 8 != (getOffset()))
        {
...
::zserio::InplaceOptionalHolder<uint32_t> SerializeNested::readOptionalValue(::zserio::pmr::PackingContextNode& contextNode, ::zserio::BitStreamReader& in)
{
    if (getParam() >= 0)
    {
        in.alignTo(UINT32_C(8));
