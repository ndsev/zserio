...
::zserio::pmr::IReflectableConstPtr WalkerObject::reflectable(const allocator_type& allocator) const
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::polymorphic_allocator::WalkerObject& object, const allocator_type& alloc) :
                ::zserio::ReflectableConstAllocatorHolderBase<allocator_type>(::test_object::polymorphic_allocator::WalkerObject::typeInfo(), alloc),
                m_object(object)
        {}
...
::zserio::pmr::IReflectablePtr WalkerObject::reflectable(const allocator_type& allocator)
{
    ...
    {
    public:
        explicit Reflectable(::test_object::polymorphic_allocator::WalkerObject& object, const allocator_type& alloc) :
                ::zserio::ReflectableAllocatorHolderBase<allocator_type>(::test_object::polymorphic_allocator::WalkerObject::typeInfo(), alloc),
                m_object(object)
        {}
...
size_t WalkerObject::bitSizeOf(size_t bitPosition) const
{
    ...
    endBitPosition += 1;
    if (m_optionalUnionArray_.hasValue())
    {
...
const ::zserio::ParsingInfo& WalkerObject::parsingInfo() const
{
