...
::zserio::InplaceOptionalHolder<::test_object::polymorphic_allocator::WalkerNested> WalkerObject::readNested(::zserio::pmr::PackingContextNode& contextNode, ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    if (getIdentifier() != 0)
    {
        return ::zserio::InplaceOptionalHolder<::test_object::polymorphic_allocator::WalkerNested>(::test_object::polymorphic_allocator::WalkerNested(contextNode.getChildren().at(1), in, allocator));
    }
