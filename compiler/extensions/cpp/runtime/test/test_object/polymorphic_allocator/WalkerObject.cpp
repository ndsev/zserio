...
void WalkerObject::createPackingContext(::zserio::pmr::PackingContextNode& contextNode)
{
    ...
    contextNode.createChild();
    contextNode.createChild().createContext();
    ::test_object::polymorphic_allocator::WalkerChoice::createPackingContext(contextNode.createChild());
}
...
uint8_t WalkerObject::readChoiceSelector(::zserio::pmr::PackingContextNode& contextNode, ::zserio::BitStreamReader& in)
{
...
::test_object::polymorphic_allocator::WalkerChoice WalkerObject::readChoiceField(::zserio::pmr::PackingContextNode& contextNode, ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    return ::test_object::polymorphic_allocator::WalkerChoice(contextNode.getChildren()[6], in, static_cast<uint8_t>(getChoiceSelector()), allocator);
}
