...
::test_object::polymorphic_allocator::WalkerChoice WalkerObject::readChoiceField(WalkerObject::ZserioPackingContext& context, ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    return ::test_object::polymorphic_allocator::WalkerChoice(context.getChoiceField(), in, static_cast<uint8_t>(getChoiceSelector()), allocator);
}
