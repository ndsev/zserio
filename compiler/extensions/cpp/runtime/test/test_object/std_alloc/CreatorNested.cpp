...
#include <test_object/std_alloc/CreatorNested.h>
...
CreatorNested::CreatorNested(const allocator_type& allocator) noexcept :
        ...
        m_creatorEnum_(::test_object::std_alloc::CreatorEnum()),
        m_creatorBitmask_(::test_object::std_alloc::CreatorBitmask())
{
}
...
CreatorNested::CreatorNested(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamReader& in,
        uint32_t param_, const allocator_type& allocator) :
        m_param_(param_),
        m_isInitialized(true),
...
const ::zserio::ITypeInfo& CreatorNested::typeInfo()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<allocator_type>, 6> fields = {
        ...
        ::zserio::BasicFieldInfo<allocator_type>{
            ...
            ::zserio::enumTypeInfo<::test_object::std_alloc::CreatorEnum, allocator_type>(), // typeInfo
            {}, // typeArguments
            {}, // alignment
            {}, // offset
            {}, // initializer
        ...
        ::zserio::BasicFieldInfo<allocator_type>{
            ...
            ::test_object::std_alloc::CreatorBitmask::typeInfo(), // typeInfo
            {}, // typeArguments
            {}, // alignment
            {}, // offset
            {}, // initializer
    ...
    static const ::zserio::StructTypeInfo<allocator_type> typeInfo = {
        ::zserio::makeStringView("test_object.std_alloc.CreatorNested"),
...
::zserio::IReflectableConstPtr CreatorNested::reflectable(const allocator_type& allocator) const
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::std_alloc::CreatorNested& object, const allocator_type& allocator) :
                ::zserio::ReflectableConstAllocatorHolderBase<allocator_type>(::test_object::std_alloc::CreatorNested::typeInfo(), allocator),
                m_object(object)
        {}
    ...
    private:
        const ::test_object::std_alloc::CreatorNested& m_object;
    };
...
::zserio::IReflectablePtr CreatorNested::reflectable(const allocator_type& allocator)
{
    ...
    {
    public:
        explicit Reflectable(::test_object::std_alloc::CreatorNested& object, const allocator_type& allocator) :
                ::zserio::ReflectableAllocatorHolderBase<allocator_type>(::test_object::std_alloc::CreatorNested::typeInfo(), allocator),
                m_object(object)
        {}
                ...
                const ::zserio::AnyHolder<allocator_type>& value) override
        {
            ...
            if (name == ::zserio::makeStringView("creatorEnum"))
            {
                if (value.isType<::test_object::std_alloc::CreatorEnum>())
                {
                    m_object.setCreatorEnum(value.get<::test_object::std_alloc::CreatorEnum>());
                }
                else
                {
                    m_object.setCreatorEnum(::zserio::valueToEnum<::test_object::std_alloc::CreatorEnum>(
                            value.get<typename ::std::underlying_type<::test_object::std_alloc::CreatorEnum>::type>()));
                }
                return;
            }
            if (name == ::zserio::makeStringView("creatorBitmask"))
            {
                if (value.isType<::test_object::std_alloc::CreatorBitmask>())
                {
                    m_object.setCreatorBitmask(value.get<::test_object::std_alloc::CreatorBitmask>());
                }
                else
                {
                    m_object.setCreatorBitmask(::test_object::std_alloc::CreatorBitmask(
                            value.get<::test_object::std_alloc::CreatorBitmask::underlying_type>()));
                }
                return;
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'CreatorNested'!";
        ...
        virtual ::zserio::IReflectablePtr createField(::zserio::StringView name) override
        {
            ...
            if (name == ::zserio::makeStringView("creatorEnum"))
            {
                m_object.setCreatorEnum(::test_object::std_alloc::CreatorEnum());
                return ::zserio::enumReflectable(m_object.getCreatorEnum(), get_allocator());
            }
            if (name == ::zserio::makeStringView("creatorBitmask"))
            {
    ...
    private:
        ::test_object::std_alloc::CreatorNested& m_object;
    };
...
::test_object::std_alloc::CreatorEnum CreatorNested::getCreatorEnum() const
{
    return m_creatorEnum_;
}

void CreatorNested::setCreatorEnum(::test_object::std_alloc::CreatorEnum creatorEnum_)
{
    m_creatorEnum_ = creatorEnum_;
}

::test_object::std_alloc::CreatorBitmask CreatorNested::getCreatorBitmask() const
{
    return m_creatorBitmask_;
}

void CreatorNested::setCreatorBitmask(::test_object::std_alloc::CreatorBitmask creatorBitmask_)
{
    m_creatorBitmask_ = creatorBitmask_;
}

void CreatorNested::createPackingContext(::zserio::PackingContextNode& contextNode)
{
    ...
    contextNode.createChild();
    contextNode.createChild().createContext();
    ::test_object::std_alloc::CreatorBitmask::createPackingContext(contextNode.createChild());
}
...
size_t CreatorNested::bitSizeOf(::zserio::PackingContextNode& contextNode, size_t bitPosition) const
{
    size_t endBitPosition = bitPosition;
    ...
    endBitPosition += ::zserio::bitSizeOf(
            contextNode.getChildren().at(4), m_creatorEnum_);
...
size_t CreatorNested::initializeOffsets(::zserio::PackingContextNode& contextNode, size_t bitPosition)
{
    size_t endBitPosition = bitPosition;
    ...
    endBitPosition = ::zserio::initializeOffsets(
            contextNode.getChildren().at(4), endBitPosition, m_creatorEnum_);
...
void CreatorNested::write(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamWriter& out) const
{
    ...
    out.writeBitBuffer(m_externData_);
    out.writeBytes(m_bytesData_);
    ::zserio::write(contextNode.getChildren().at(4), out, m_creatorEnum_);
    m_creatorBitmask_.write(contextNode.getChildren().at(5), out);
}
...
::test_object::std_alloc::CreatorEnum CreatorNested::readCreatorEnum(::zserio::BitStreamReader& in)
{
    return ::zserio::read<::test_object::std_alloc::CreatorEnum>(in);
}

::test_object::std_alloc::CreatorEnum CreatorNested::readCreatorEnum(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamReader& in)
{
    return ::zserio::read<::test_object::std_alloc::CreatorEnum>(contextNode.getChildren().at(4), in);
}

::test_object::std_alloc::CreatorBitmask CreatorNested::readCreatorBitmask(::zserio::BitStreamReader& in)
{
    return ::test_object::std_alloc::CreatorBitmask(in);
}

::test_object::std_alloc::CreatorBitmask CreatorNested::readCreatorBitmask(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamReader& in)
{
    return ::test_object::std_alloc::CreatorBitmask(contextNode.getChildren().at(5), in);
}
