...
#ifndef TEST_OBJECT_STD_ALLOC_CREATOR_NESTED_H
#define TEST_OBJECT_STD_ALLOC_CREATOR_NESTED_H
...
#include <test_object/std_alloc/CreatorBitmask.h>
...
public:
    ...
    CreatorNested(
            ...
            ::test_object::std_alloc::CreatorEnum creatorEnum_,
            ::test_object::std_alloc::CreatorBitmask creatorBitmask_,
    ...
    ::test_object::std_alloc::CreatorEnum getCreatorEnum() const;
    void setCreatorEnum(::test_object::std_alloc::CreatorEnum creatorEnum_);

    ::test_object::std_alloc::CreatorBitmask getCreatorBitmask() const;
    void setCreatorBitmask(::test_object::std_alloc::CreatorBitmask creatorBitmask_);
...
private:
    ...
    ::zserio::vector<uint8_t> readBytesData(::zserio::BitStreamReader& in,
            const allocator_type& allocator);
    ::test_object::std_alloc::CreatorEnum readCreatorEnum(::zserio::BitStreamReader& in);
    ::test_object::std_alloc::CreatorEnum readCreatorEnum(::zserio::PackingContextNode& contextNode,
            ::zserio::BitStreamReader& in);
    ::test_object::std_alloc::CreatorBitmask readCreatorBitmask(::zserio::BitStreamReader& in);
    ::test_object::std_alloc::CreatorBitmask readCreatorBitmask(::zserio::PackingContextNode& contextNode,
            ::zserio::BitStreamReader& in);
    ...
    ::test_object::std_alloc::CreatorEnum m_creatorEnum_;
    ::test_object::std_alloc::CreatorBitmask m_creatorBitmask_;
};

} // namespace std_alloc
} // namespace test_object

#endif // TEST_OBJECT_STD_ALLOC_CREATOR_NESTED_H
