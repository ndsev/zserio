...
#include <test_object/std_alloc/CreatorObject.h>
...
void CreatorObject::ZserioElementFactory_nestedArray::create(::zserio::vector<::test_object::std_alloc::CreatorNested>& array,
...
void CreatorObject::ZserioElementFactory_nestedArray::create(::zserio::PackingContextNode& contextNode,
        ::zserio::vector<::test_object::std_alloc::CreatorNested>& array, ::zserio::BitStreamReader& in, size_t index) const
{
    (void)index;
...
void CreatorObject::ZserioElementInitializer_nestedArray::initialize(::test_object::std_alloc::CreatorNested& element, size_t index) const
{
    (void)index;
...
CreatorObject::CreatorObject(const allocator_type& allocator) noexcept :
        ...
        m_nested_(allocator),
        m_text_(allocator),
        m_nestedArray_(::zserio::ObjectArrayTraits<::test_object::std_alloc::CreatorNested, ZserioElementFactory_nestedArray>(), allocator),
...
const ::zserio::ITypeInfo& CreatorObject::typeInfo()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<allocator_type>, 9> fields = {
        ...
        ::zserio::BasicFieldInfo<allocator_type>{
            ...
            ::test_object::std_alloc::CreatorNested::typeInfo(), // typeInfo
    ...
    static const ::zserio::StructTypeInfo<allocator_type> typeInfo = {
        ::zserio::makeStringView("test_object.std_alloc.CreatorObject"),
...
::zserio::IReflectableConstPtr CreatorObject::reflectable(const allocator_type& allocator) const
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::std_alloc::CreatorObject& object, const allocator_type& allocator) :
                ::zserio::ReflectableConstAllocatorHolderBase<allocator_type>(::test_object::std_alloc::CreatorObject::typeInfo(), allocator),
                m_object(object)
        {}
    ...
    private:
        const ::test_object::std_alloc::CreatorObject& m_object;
    };
...
::zserio::IReflectablePtr CreatorObject::reflectable(const allocator_type& allocator)
{
    ...
    {
    public:
        explicit Reflectable(::test_object::std_alloc::CreatorObject& object, const allocator_type& allocator) :
                ::zserio::ReflectableAllocatorHolderBase<allocator_type>(::test_object::std_alloc::CreatorObject::typeInfo(), allocator),
                m_object(object)
        {}
                ...
                const ::zserio::AnyHolder<allocator_type>& value) override
        {
            ...
            if (name == ::zserio::makeStringView("nested"))
            {
                m_object.setNested(value.get<::test_object::std_alloc::CreatorNested>());
                return;
            }
            if (name == ::zserio::makeStringView("text"))
            {
            ...
            if (name == ::zserio::makeStringView("nestedArray"))
            {
                m_object.setNestedArray(value.get<::zserio::vector<::test_object::std_alloc::CreatorNested>>());
                return;
            }
            if (name == ::zserio::makeStringView("textArray"))
            {
            ...
            if (name == ::zserio::makeStringView("optionalNested"))
            {
                ...
                m_object.setOptionalNested(value.get<::test_object::std_alloc::CreatorNested>());
                return;
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'CreatorObject'!";
        }
        ...
        virtual ::zserio::IReflectablePtr createField(::zserio::StringView name) override
        {
            ...
            if (name == ::zserio::makeStringView("nested"))
            {
                m_object.setNested(::test_object::std_alloc::CreatorNested(get_allocator()));
                return m_object.getNested().reflectable(get_allocator());
            }
            if (name == ::zserio::makeStringView("text"))
            {
            ...
            if (name == ::zserio::makeStringView("nestedArray"))
            {
                m_object.setNestedArray(::zserio::vector<::test_object::std_alloc::CreatorNested>(get_allocator()));
                return ::zserio::ReflectableFactory::getCompoundArray(m_object.getNestedArray(), get_allocator());
            }
            if (name == ::zserio::makeStringView("textArray"))
            {
            ...
            if (name == ::zserio::makeStringView("optionalNested"))
            {
                m_object.setOptionalNested(::test_object::std_alloc::CreatorNested(get_allocator()));
                return m_object.getOptionalNested().reflectable(get_allocator());
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'CreatorObject'!";
        }
    ...
    private:
        ::test_object::std_alloc::CreatorObject& m_object;
    };
...
::test_object::std_alloc::CreatorNested& CreatorObject::getNested()
{
    return m_nested_;
}

const ::test_object::std_alloc::CreatorNested& CreatorObject::getNested() const
{
    return m_nested_;
}

void CreatorObject::setNested(const ::test_object::std_alloc::CreatorNested& nested_)
{
    m_nested_ = nested_;
}

void CreatorObject::setNested(::test_object::std_alloc::CreatorNested&& nested_)
{
...
::zserio::vector<::test_object::std_alloc::CreatorNested>& CreatorObject::getNestedArray()
{
    return m_nestedArray_.getRawArray();
}

const ::zserio::vector<::test_object::std_alloc::CreatorNested>& CreatorObject::getNestedArray() const
{
    return m_nestedArray_.getRawArray();
}

void CreatorObject::setNestedArray(const ::zserio::vector<::test_object::std_alloc::CreatorNested>& nestedArray_)
{
    m_nestedArray_ = ZserioArrayType_nestedArray(nestedArray_, ::zserio::ObjectArrayTraits<::test_object::std_alloc::CreatorNested, ZserioElementFactory_nestedArray>());
}

void CreatorObject::setNestedArray(::zserio::vector<::test_object::std_alloc::CreatorNested>&& nestedArray_)
{
    m_nestedArray_ = ZserioArrayType_nestedArray(std::move(nestedArray_), ::zserio::ObjectArrayTraits<::test_object::std_alloc::CreatorNested, ZserioElementFactory_nestedArray>());
}
...
::test_object::std_alloc::CreatorNested& CreatorObject::getOptionalNested()
{
    return m_optionalNested_.value();
}

const ::test_object::std_alloc::CreatorNested& CreatorObject::getOptionalNested() const
{
    return m_optionalNested_.value();
}

void CreatorObject::setOptionalNested(const ::test_object::std_alloc::CreatorNested& optionalNested_)
{
    m_optionalNested_ = optionalNested_;
}

void CreatorObject::setOptionalNested(::test_object::std_alloc::CreatorNested&& optionalNested_)
{
...
void CreatorObject::createPackingContext(::zserio::PackingContextNode& contextNode)
{
    ...
    ::test_object::std_alloc::CreatorNested::createPackingContext(contextNode.createChild());
...
::test_object::std_alloc::CreatorNested CreatorObject::readNested(::zserio::BitStreamReader& in,
        const allocator_type& allocator)
{
    return ::test_object::std_alloc::CreatorNested(in, static_cast<uint32_t>(getValue()), allocator);
}

::test_object::std_alloc::CreatorNested CreatorObject::readNested(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    return ::test_object::std_alloc::CreatorNested(contextNode.getChildren().at(1), in, static_cast<uint32_t>(getValue()), allocator);
}
...
CreatorObject::ZserioArrayType_nestedArray CreatorObject::readNestedArray(::zserio::BitStreamReader& in,
        const allocator_type& allocator)
{
    ZserioArrayType_nestedArray readField(::zserio::ObjectArrayTraits<::test_object::std_alloc::CreatorNested, ZserioElementFactory_nestedArray>(), allocator);
...
::zserio::InplaceOptionalHolder<::test_object::std_alloc::CreatorNested> CreatorObject::readOptionalNested(::zserio::BitStreamReader& in,
        const allocator_type& allocator)
{
    if (in.readBool())
    {
        return ::zserio::InplaceOptionalHolder<::test_object::std_alloc::CreatorNested>(::test_object::std_alloc::CreatorNested(in, static_cast<uint32_t>(getValue()), allocator));
    }

    return ::zserio::InplaceOptionalHolder<::test_object::std_alloc::CreatorNested>(::zserio::NullOpt);
}

::zserio::InplaceOptionalHolder<::test_object::std_alloc::CreatorNested> CreatorObject::readOptionalNested(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    if (in.readBool())
    {
        return ::zserio::InplaceOptionalHolder<::test_object::std_alloc::CreatorNested>(::test_object::std_alloc::CreatorNested(contextNode.getChildren().at(8), in, static_cast<uint32_t>(getValue()), allocator));
    }
