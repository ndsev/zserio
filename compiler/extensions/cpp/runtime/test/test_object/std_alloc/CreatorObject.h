...
#ifndef TEST_OBJECT_STD_ALLOC_CREATOR_OBJECT_H
#define TEST_OBJECT_STD_ALLOC_CREATOR_OBJECT_H
...
private:
    ...
    public:
        ...
        void create(::zserio::vector<::test_object::std_alloc::CreatorNested>& array,
                ::zserio::BitStreamReader& in, size_t index) const;

        void create(::zserio::PackingContextNode& contextNode,
                ::zserio::vector<::test_object::std_alloc::CreatorNested>& array,
                ::zserio::BitStreamReader& in, size_t index) const;
    ...
    public:
        ...
        void initialize(::test_object::std_alloc::CreatorNested& element, size_t index) const;

    private:
        std::reference_wrapper<CreatorObject> m_ownerRef;
    };

    using ZserioArrayType_nestedArray = ::zserio::Array<::zserio::vector<::test_object::std_alloc::CreatorNested>, ::zserio::ObjectArrayTraits<::test_object::std_alloc::CreatorNested, ZserioElementFactory_nestedArray>, ::zserio::ArrayType::AUTO>;
...
public:
            ...
            CreatorObject(allocator)
    {
        ...
        m_nestedArray_ = ZserioArrayType_nestedArray(::std::forward<ZSERIO_T_nestedArray>(nestedArray_), ::zserio::ObjectArrayTraits<::test_object::std_alloc::CreatorNested, ZserioElementFactory_nestedArray>());
    ...
    const ::test_object::std_alloc::CreatorNested& getNested() const;
    ::test_object::std_alloc::CreatorNested& getNested();
    void setNested(const ::test_object::std_alloc::CreatorNested& nested_);
    void setNested(::test_object::std_alloc::CreatorNested&& nested_);
    ...
    const ::zserio::vector<::test_object::std_alloc::CreatorNested>& getNestedArray() const;
    ::zserio::vector<::test_object::std_alloc::CreatorNested>& getNestedArray();
    void setNestedArray(const ::zserio::vector<::test_object::std_alloc::CreatorNested>& nestedArray_);
    void setNestedArray(::zserio::vector<::test_object::std_alloc::CreatorNested>&& nestedArray_);
    ...
    const ::test_object::std_alloc::CreatorNested& getOptionalNested() const;
    ::test_object::std_alloc::CreatorNested& getOptionalNested();
    void setOptionalNested(const ::test_object::std_alloc::CreatorNested& optionalNested_);
    void setOptionalNested(::test_object::std_alloc::CreatorNested&& optionalNested_);
...
private:
    ...
    ::test_object::std_alloc::CreatorNested readNested(::zserio::BitStreamReader& in,
            const allocator_type& allocator);
    ::test_object::std_alloc::CreatorNested readNested(::zserio::PackingContextNode& contextNode,
    ...
    ::zserio::InplaceOptionalHolder<::test_object::std_alloc::CreatorNested> readOptionalNested(::zserio::BitStreamReader& in,
            const allocator_type& allocator);
    ::zserio::InplaceOptionalHolder<::test_object::std_alloc::CreatorNested> readOptionalNested(::zserio::PackingContextNode& contextNode,
            ::zserio::BitStreamReader& in, const allocator_type& allocator);

    bool m_areChildrenInitialized;
    uint32_t m_value_;
    ::test_object::std_alloc::CreatorNested m_nested_;
    ...
    ::zserio::InplaceOptionalHolder<::test_object::std_alloc::CreatorNested> m_optionalNested_;
};

} // namespace std_alloc
} // namespace test_object

#endif // TEST_OBJECT_STD_ALLOC_CREATOR_OBJECT_H
