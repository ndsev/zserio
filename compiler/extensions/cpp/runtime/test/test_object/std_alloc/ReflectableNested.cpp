...
#include <test_object/std_alloc/ReflectableNested.h>
...
const ::zserio::ITypeInfo& ReflectableNested::typeInfo()
{
    ...
    static const ::zserio::StructTypeInfo<allocator_type> typeInfo = {
        ::zserio::makeStringView("test_object.std_alloc.ReflectableNested"),
...
::zserio::IReflectableConstPtr ReflectableNested::reflectable(const allocator_type& allocator) const
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::std_alloc::ReflectableNested& object, const allocator_type& allocator) :
                ::zserio::ReflectableConstAllocatorHolderBase<allocator_type>(::test_object::std_alloc::ReflectableNested::typeInfo(), allocator),
                m_object(object)
        {}
        ...
        virtual ::zserio::IReflectableConstPtr getField(::zserio::StringView name) const override
        {
            ...
            {
                return ::zserio::ReflectableFactory::getFixedUnsignedBitField(UINT8_C(31), m_object.getValue(), get_allocator());
            }
        ...
        virtual ::zserio::IReflectableConstPtr getParameter(::zserio::StringView name) const override
        {
            ...
            {
                return ::zserio::ReflectableFactory::getFixedSignedBitField(UINT8_C(31), m_object.getDummyParam(), get_allocator());
            }
        ...
        virtual ::zserio::IReflectableConstPtr callFunction(::zserio::StringView name) const override
        {
            if (name == ::zserio::makeStringView("getValue"))
            {
                return ::zserio::ReflectableFactory::getFixedUnsignedBitField(UINT8_C(31), m_object.funcGetValue(), get_allocator());
            }
    ...
    private:
        const ::test_object::std_alloc::ReflectableNested& m_object;
    };
...
::zserio::IReflectablePtr ReflectableNested::reflectable(const allocator_type& allocator)
{
    ...
    {
    public:
        explicit Reflectable(::test_object::std_alloc::ReflectableNested& object, const allocator_type& allocator) :
                ::zserio::ReflectableAllocatorHolderBase<allocator_type>(::test_object::std_alloc::ReflectableNested::typeInfo(), allocator),
                m_object(object)
        {}
        ...
        virtual ::zserio::IReflectablePtr callFunction(::zserio::StringView name) override
        {
            if (name == ::zserio::makeStringView("getValue"))
            {
                return ::zserio::ReflectableFactory::getFixedUnsignedBitField(UINT8_C(31), m_object.funcGetValue(), get_allocator());
    ...
    private:
        ::test_object::std_alloc::ReflectableNested& m_object;
    };
