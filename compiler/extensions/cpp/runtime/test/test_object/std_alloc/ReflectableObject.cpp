...
#include <test_object/std_alloc/ReflectableObject.h>
...
ReflectableObject::ReflectableObject(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamReader& in, const allocator_type& allocator) :
        m_areChildrenInitialized(true),
        m_stringField_(readStringField(in, allocator)),
...
const ::zserio::ITypeInfo& ReflectableObject::typeInfo()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<allocator_type>, 2> fields = {
        ...
        ::zserio::BasicFieldInfo<allocator_type>{
            ...
            ::test_object::std_alloc::ReflectableNested::typeInfo(), // typeInfo
    ...
    static const ::zserio::StructTypeInfo<allocator_type> typeInfo = {
        ::zserio::makeStringView("test_object.std_alloc.ReflectableObject"),
...
::zserio::IReflectableConstPtr ReflectableObject::reflectable(const allocator_type& allocator) const
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::std_alloc::ReflectableObject& object, const allocator_type& allocator) :
                ::zserio::ReflectableConstAllocatorHolderBase<allocator_type>(::test_object::std_alloc::ReflectableObject::typeInfo(), allocator),
                m_object(object)
        {}
    ...
    private:
        const ::test_object::std_alloc::ReflectableObject& m_object;
    };
...
::zserio::IReflectablePtr ReflectableObject::reflectable(const allocator_type& allocator)
{
    ...
    {
    public:
        explicit Reflectable(::test_object::std_alloc::ReflectableObject& object, const allocator_type& allocator) :
                ::zserio::ReflectableAllocatorHolderBase<allocator_type>(::test_object::std_alloc::ReflectableObject::typeInfo(), allocator),
                m_object(object)
        {}
                ...
                const ::zserio::AnyHolder<allocator_type>& value) override
        {
            ...
            if (name == ::zserio::makeStringView("reflectableNested"))
            {
                m_object.setReflectableNested(value.get<::test_object::std_alloc::ReflectableNested>());
                return;
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'ReflectableObject'!";
        }
        ...
        virtual ::zserio::IReflectablePtr createField(::zserio::StringView name) override
        {
            ...
            if (name == ::zserio::makeStringView("reflectableNested"))
            {
                m_object.setReflectableNested(::test_object::std_alloc::ReflectableNested(get_allocator()));
                return m_object.getReflectableNested().reflectable(get_allocator());
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'ReflectableObject'!";
        }
    ...
    private:
        ::test_object::std_alloc::ReflectableObject& m_object;
    };
...
::test_object::std_alloc::ReflectableNested& ReflectableObject::getReflectableNested()
{
    return m_reflectableNested_;
}

const ::test_object::std_alloc::ReflectableNested& ReflectableObject::getReflectableNested() const
{
    return m_reflectableNested_;
}

void ReflectableObject::setReflectableNested(const ::test_object::std_alloc::ReflectableNested& reflectableNested_)
{
    m_reflectableNested_ = reflectableNested_;
}

void ReflectableObject::setReflectableNested(::test_object::std_alloc::ReflectableNested&& reflectableNested_)
{
    m_reflectableNested_ = ::std::move(reflectableNested_);
}

void ReflectableObject::createPackingContext(::zserio::PackingContextNode& contextNode)
{
    contextNode.createChild();
    ::test_object::std_alloc::ReflectableNested::createPackingContext(contextNode.createChild());
}

void ReflectableObject::initPackingContext(::zserio::PackingContextNode& contextNode) const
{
    m_reflectableNested_.initPackingContext(contextNode.getChildren().at(1));
}
...
size_t ReflectableObject::bitSizeOf(::zserio::PackingContextNode& contextNode, size_t bitPosition) const
{
    size_t endBitPosition = bitPosition;
...
size_t ReflectableObject::initializeOffsets(::zserio::PackingContextNode& contextNode, size_t bitPosition)
{
    size_t endBitPosition = bitPosition;
...
void ReflectableObject::write(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamWriter& out) const
{
    out.writeString(m_stringField_);
    ...
    m_reflectableNested_.write(contextNode.getChildren().at(1), out);
}
...
::test_object::std_alloc::ReflectableNested ReflectableObject::readReflectableNested(::zserio::BitStreamReader& in,
        const allocator_type& allocator)
{
    return ::test_object::std_alloc::ReflectableNested(in, static_cast<int32_t>(13), getStringField(), allocator);
}

::test_object::std_alloc::ReflectableNested ReflectableObject::readReflectableNested(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    return ::test_object::std_alloc::ReflectableNested(contextNode.getChildren().at(1), in, static_cast<int32_t>(13), getStringField(), allocator);
}
