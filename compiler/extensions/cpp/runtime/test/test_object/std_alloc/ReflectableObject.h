...
#ifndef TEST_OBJECT_STD_ALLOC_REFLECTABLE_OBJECT_H
#define TEST_OBJECT_STD_ALLOC_REFLECTABLE_OBJECT_H
...
public:
    ...
    explicit ReflectableObject(::zserio::PackingContextNode& contextNode,
    ...
    const ::test_object::std_alloc::ReflectableNested& getReflectableNested() const;
    ::test_object::std_alloc::ReflectableNested& getReflectableNested();
    void setReflectableNested(const ::test_object::std_alloc::ReflectableNested& reflectableNested_);
    void setReflectableNested(::test_object::std_alloc::ReflectableNested&& reflectableNested_);
...
private:
    ...
    ::test_object::std_alloc::ReflectableNested readReflectableNested(::zserio::BitStreamReader& in,
            const allocator_type& allocator);
    ::test_object::std_alloc::ReflectableNested readReflectableNested(::zserio::PackingContextNode& contextNode,
            ::zserio::BitStreamReader& in, const allocator_type& allocator);

    bool m_areChildrenInitialized;
    ::zserio::string<> m_stringField_;
    ::test_object::std_alloc::ReflectableNested m_reflectableNested_;
};

} // namespace std_alloc
} // namespace test_object

#endif // TEST_OBJECT_STD_ALLOC_REFLECTABLE_OBJECT_H
