...
#include <test_object/std_alloc/SerializeObject.h>
...
const ::zserio::ITypeInfo& SerializeObject::typeInfo()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<allocator_type>, 2> fields = {
        ...
        ::zserio::BasicFieldInfo<allocator_type>{
            ...
            ::test_object::std_alloc::SerializeNested::typeInfo(), // typeInfo
    ...
    static const ::zserio::StructTypeInfo<allocator_type> typeInfo = {
        ::zserio::makeStringView("test_object.std_alloc.SerializeObject"),
...
::zserio::IReflectableConstPtr SerializeObject::reflectable(const allocator_type& allocator) const
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::std_alloc::SerializeObject& object, const allocator_type& allocator) :
                ::zserio::ReflectableConstAllocatorHolderBase<allocator_type>(::test_object::std_alloc::SerializeObject::typeInfo(), allocator),
                m_object(object)
        {}
    ...
    private:
        const ::test_object::std_alloc::SerializeObject& m_object;
    };
...
::zserio::IReflectablePtr SerializeObject::reflectable(const allocator_type& allocator)
{
    ...
    {
    public:
        explicit Reflectable(::test_object::std_alloc::SerializeObject& object, const allocator_type& allocator) :
                ::zserio::ReflectableAllocatorHolderBase<allocator_type>(::test_object::std_alloc::SerializeObject::typeInfo(), allocator),
                m_object(object)
        {}
                ...
                const ::zserio::AnyHolder<allocator_type>& value) override
        {
            ...
            if (name == ::zserio::makeStringView("nested"))
            {
                m_object.setNested(value.get<::test_object::std_alloc::SerializeNested>());
                return;
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'SerializeObject'!";
        }
        ...
        virtual ::zserio::IReflectablePtr createField(::zserio::StringView name) override
        {
            ...
            if (name == ::zserio::makeStringView("nested"))
            {
                m_object.setNested(::test_object::std_alloc::SerializeNested(get_allocator()));
                return m_object.getNested().reflectable(get_allocator());
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'SerializeObject'!";
        }
    ...
    private:
        ::test_object::std_alloc::SerializeObject& m_object;
    };
...
::test_object::std_alloc::SerializeNested& SerializeObject::getNested()
{
    return m_nested_;
}

const ::test_object::std_alloc::SerializeNested& SerializeObject::getNested() const
{
    return m_nested_;
}

void SerializeObject::setNested(const ::test_object::std_alloc::SerializeNested& nested_)
{
    m_nested_ = nested_;
}

void SerializeObject::setNested(::test_object::std_alloc::SerializeNested&& nested_)
{
...
void SerializeObject::createPackingContext(::zserio::PackingContextNode& contextNode)
{
    ...
    ::test_object::std_alloc::SerializeNested::createPackingContext(contextNode.createChild());
}
...
::test_object::std_alloc::SerializeNested SerializeObject::readNested(::zserio::BitStreamReader& in,
        const allocator_type& allocator)
{
    return ::test_object::std_alloc::SerializeNested(in, static_cast<int8_t>(getParam()), allocator);
}

::test_object::std_alloc::SerializeNested SerializeObject::readNested(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    return ::test_object::std_alloc::SerializeNested(contextNode.getChildren().at(1), in, static_cast<int8_t>(getParam()), allocator);
}
