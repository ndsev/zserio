...
#include <test_object/std_alloc/WalkerBitmask.h>
...
const ::zserio::ITypeInfo& WalkerBitmask::typeInfo()
{
    ...
    static const ::zserio::BitmaskTypeInfo<allocator_type> typeInfo = {
        ::zserio::makeStringView("test_object.std_alloc.WalkerBitmask"),
...
::zserio::IReflectablePtr WalkerBitmask::reflectable(const ::std::allocator<uint8_t>& allocator) const
{
    ...
    {
    public:
        explicit Reflectable(::test_object::std_alloc::WalkerBitmask bitmask) :
                ::zserio::ReflectableBase<::std::allocator<uint8_t>>(::test_object::std_alloc::WalkerBitmask::typeInfo()),
                m_bitmask(bitmask)
        {}
    ...
    private:
        ::test_object::std_alloc::WalkerBitmask m_bitmask;
    };
...
{
    contextNode.getContext().init(::zserio::StdIntArrayTraits<::test_object::std_alloc::WalkerBitmask::underlying_type>(),
            m_value);
}
...
size_t WalkerBitmask::bitSizeOf(::zserio::PackingContextNode& contextNode, size_t) const
{
    return contextNode.getContext().bitSizeOf(
            ::zserio::StdIntArrayTraits<::test_object::std_alloc::WalkerBitmask::underlying_type>(),
            m_value);
}
        ...
        ::zserio::BitStreamReader& in)
{
    return contextNode.getContext().read(
            ::zserio::StdIntArrayTraits<::test_object::std_alloc::WalkerBitmask::underlying_type>(), in);
}
