...
#ifndef TEST_OBJECT_STD_ALLOC_WALKER_UNION_H
#define TEST_OBJECT_STD_ALLOC_WALKER_UNION_H
...
private:
    ...
    public:
        ...
        void create(::zserio::vector<::test_object::std_alloc::WalkerNested>& array,
                ::zserio::BitStreamReader& in, size_t index) const;

        void create(::zserio::PackingContextNode& contextNode,
                ::zserio::vector<::test_object::std_alloc::WalkerNested>& array,
                ::zserio::BitStreamReader& in, size_t index) const;
    ...
    using ZserioArrayType_nestedArray = ::zserio::Array<::zserio::vector<::test_object::std_alloc::WalkerNested>, ::zserio::ObjectArrayTraits<::test_object::std_alloc::WalkerNested, ZserioElementFactory_nestedArray>, ::zserio::ArrayType::AUTO>;
...
public:
    ...
    const ::zserio::vector<::test_object::std_alloc::WalkerNested>& getNestedArray() const;
    ::zserio::vector<::test_object::std_alloc::WalkerNested>& getNestedArray();
    void setNestedArray(const ::zserio::vector<::test_object::std_alloc::WalkerNested>& nestedArray_);
    void setNestedArray(::zserio::vector<::test_object::std_alloc::WalkerNested>&& nestedArray_);
...
#endif // TEST_OBJECT_STD_ALLOC_WALKER_UNION_H
