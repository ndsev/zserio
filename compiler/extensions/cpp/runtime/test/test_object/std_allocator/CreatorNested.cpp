...
{
    return ::zserio::read<::test_object::std_allocator::CreatorEnum>(contextNode.getChildren()[4], in);
}
...
{
    return ::test_object::std_allocator::CreatorBitmask(contextNode.getChildren()[5], in);
}
