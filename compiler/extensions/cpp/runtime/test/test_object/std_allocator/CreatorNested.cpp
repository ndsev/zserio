...
void CreatorNested::createPackingContext(::zserio::PackingContextNode& contextNode)
{
    ...
    contextNode.createChild();
    contextNode.createChild().createContext();
    ::test_object::std_allocator::CreatorBitmask::createPackingContext(contextNode.createChild());
}
...
::test_object::std_allocator::CreatorEnum CreatorNested::readCreatorEnum(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamReader& in)
{
    return ::zserio::read<::test_object::std_allocator::CreatorEnum>(contextNode.getChildren().at(4), in);
}
...
::test_object::std_allocator::CreatorBitmask CreatorNested::readCreatorBitmask(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamReader& in)
{
    return ::test_object::std_allocator::CreatorBitmask(contextNode.getChildren().at(5), in);
}
