...
::test_object::std_allocator::CreatorNested CreatorObject::readNested(CreatorObject::ZserioPackingContext& context, ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    return ::test_object::std_allocator::CreatorNested(context.getNested(), in, static_cast<uint32_t>(getValue()), allocator);
}
...
::zserio::InplaceOptionalHolder<::test_object::std_allocator::CreatorNested> CreatorObject::readOptionalNested(CreatorObject::ZserioPackingContext& context, ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    if (in.readBool())
    {
        return ::zserio::InplaceOptionalHolder<::test_object::std_allocator::CreatorNested>(::test_object::std_allocator::CreatorNested(context.getOptionalNested(), in, static_cast<uint32_t>(getValue()), allocator));
    }
