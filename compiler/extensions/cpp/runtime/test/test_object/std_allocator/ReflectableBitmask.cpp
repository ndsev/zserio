...
{
    context.init<::zserio::StdIntArrayTraits<::test_object::std_allocator::ReflectableBitmask::underlying_type>>(m_value);
}
...
{
    return context.bitSizeOf<::zserio::StdIntArrayTraits<::test_object::std_allocator::ReflectableBitmask::underlying_type>>(m_value);
}
...
{
    context.write<::zserio::StdIntArrayTraits<::test_object::std_allocator::ReflectableBitmask::underlying_type>>(out, m_value);
}
...
{
    return context.read<::zserio::StdIntArrayTraits<::test_object::std_allocator::ReflectableBitmask::underlying_type>>(
            in);
}
