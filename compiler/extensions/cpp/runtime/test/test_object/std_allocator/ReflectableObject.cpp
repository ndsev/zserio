...
void ReflectableObject::createPackingContext(::zserio::PackingContextNode& contextNode)
{
    ...
    ::test_object::std_allocator::ReflectableNested::createPackingContext(contextNode.createChild());
}
...
::test_object::std_allocator::ReflectableNested ReflectableObject::readReflectableNested(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    return ::test_object::std_allocator::ReflectableNested(contextNode.getChildren().at(1), in, static_cast<int32_t>(13), getStringField(), allocator);
}
