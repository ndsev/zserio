...
ReflectableUtilBitmask::ReflectableUtilBitmask(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamReader& in) :
...
void ReflectableUtilBitmask::createPackingContext(::zserio::PackingContextNode& contextNode)
{
    contextNode.createContext();
}

void ReflectableUtilBitmask::initPackingContext(::zserio::PackingContextNode& contextNode) const
{
    contextNode.getContext().init<::zserio::StdIntArrayTraits<::test_object::std_allocator::ReflectableUtilBitmask::underlying_type>>(
            m_value);
}
...
size_t ReflectableUtilBitmask::bitSizeOf(::zserio::PackingContextNode& contextNode, size_t) const
{
    return contextNode.getContext().bitSizeOf<::zserio::StdIntArrayTraits<::test_object::std_allocator::ReflectableUtilBitmask::underlying_type>>(
            m_value);
}
...
size_t ReflectableUtilBitmask::initializeOffsets(::zserio::PackingContextNode& contextNode, size_t bitPosition) const
{
...
void ReflectableUtilBitmask::write(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamWriter& out) const
{
    contextNode.getContext().write<::zserio::StdIntArrayTraits<::test_object::std_allocator::ReflectableUtilBitmask::underlying_type>>(
            out, m_value);
}
...
ReflectableUtilBitmask::underlying_type ReflectableUtilBitmask::readValue(::zserio::PackingContextNode& contextNode,
        ::zserio::BitStreamReader& in)
{
    return contextNode.getContext().read<::zserio::StdIntArrayTraits<::test_object::std_allocator::ReflectableUtilBitmask::underlying_type>>(
            in);
}
