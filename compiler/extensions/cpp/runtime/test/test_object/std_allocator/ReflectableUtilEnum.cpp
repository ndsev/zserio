...
template <>
void initPackingContext(::zserio::PackingContextNode& contextNode, ::test_object::std_allocator::ReflectableUtilEnum value)
{
    contextNode.getContext().init<::zserio::StdIntArrayTraits<typename ::std::underlying_type<::test_object::std_allocator::ReflectableUtilEnum>::type>>(
...
template <>
size_t bitSizeOf(::zserio::PackingContextNode& contextNode, ::test_object::std_allocator::ReflectableUtilEnum value)
{
    return contextNode.getContext().bitSizeOf<::zserio::StdIntArrayTraits<typename ::std::underlying_type<::test_object::std_allocator::ReflectableUtilEnum>::type>>(
            ::zserio::enumToValue(value));
}
...
size_t initializeOffsets(::zserio::PackingContextNode& contextNode,
        size_t bitPosition, ::test_object::std_allocator::ReflectableUtilEnum value)
{
...
template <>
::test_object::std_allocator::ReflectableUtilEnum read(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamReader& in)
{
    return valueToEnum<::test_object::std_allocator::ReflectableUtilEnum>(contextNode.getContext().read<::zserio::StdIntArrayTraits<typename ::std::underlying_type<::test_object::std_allocator::ReflectableUtilEnum>::type>>(
            in));
}
...
template <>
void write(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamWriter& out, ::test_object::std_allocator::ReflectableUtilEnum value)
{
    contextNode.getContext().write<::zserio::StdIntArrayTraits<typename ::std::underlying_type<::test_object::std_allocator::ReflectableUtilEnum>::type>>(
