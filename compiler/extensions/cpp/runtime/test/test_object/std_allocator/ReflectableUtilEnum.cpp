...
template <>
void initPackingContext(::zserio::DeltaContext& context, ::test_object::std_allocator::ReflectableUtilEnum value)
{
    context.init<::zserio::StdIntArrayTraits<typename ::std::underlying_type<::test_object::std_allocator::ReflectableUtilEnum>::type>>(
...
template <>
size_t bitSizeOf(::zserio::DeltaContext& context, ::test_object::std_allocator::ReflectableUtilEnum value)
{
    return context.bitSizeOf<::zserio::StdIntArrayTraits<typename ::std::underlying_type<::test_object::std_allocator::ReflectableUtilEnum>::type>>(
            ::zserio::enumToValue(value));
}
...
template <>
size_t initializeOffsets(::zserio::DeltaContext& context, size_t bitPosition, ::test_object::std_allocator::ReflectableUtilEnum value)
{
...
template <>
::test_object::std_allocator::ReflectableUtilEnum read(::zserio::DeltaContext& context, ::zserio::BitStreamReader& in)
{
    return valueToEnum<::test_object::std_allocator::ReflectableUtilEnum>(context.read<::zserio::StdIntArrayTraits<typename ::std::underlying_type<::test_object::std_allocator::ReflectableUtilEnum>::type>>(
            in));
}
...
template <>
void write(::zserio::DeltaContext& context, ::zserio::BitStreamWriter& out, ::test_object::std_allocator::ReflectableUtilEnum value)
{
    context.write<::zserio::StdIntArrayTraits<typename ::std::underlying_type<::test_object::std_allocator::ReflectableUtilEnum>::type>>(
