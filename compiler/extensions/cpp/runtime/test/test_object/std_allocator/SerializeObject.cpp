...
::test_object::std_allocator::SerializeNested SerializeObject::readNested(SerializeObject::ZserioPackingContext& context, ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    return ::test_object::std_allocator::SerializeNested(context.getNested(), in, static_cast<int8_t>(getParam()), allocator);
}
