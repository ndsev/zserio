...
WalkerChoice::WalkerChoice(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamReader& in,
        uint8_t selector_, const allocator_type& allocator) :
        m_selector_(selector_),
        m_isInitialized(true),
...
void WalkerChoice::createPackingContext(::zserio::PackingContextNode& contextNode)
{
...
void WalkerChoice::initPackingContext(::zserio::PackingContextNode& contextNode) const
{
    switch (getSelector())
    {
    case 8:
...
size_t WalkerChoice::bitSizeOf(::zserio::PackingContextNode& contextNode, size_t bitPosition) const
{
    size_t endBitPosition = bitPosition;
...
size_t WalkerChoice::initializeOffsets(::zserio::PackingContextNode& contextNode, size_t bitPosition)
{
    size_t endBitPosition = bitPosition;
...
void WalkerChoice::write(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamWriter& out) const
{
    switch (getSelector())
    {
    case 8:
...
::zserio::AnyHolder<> WalkerChoice::readObject(::zserio::PackingContextNode& contextNode,
        ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    switch (getSelector())
    {
    case 8:
        return ::zserio::AnyHolder<>(contextNode.getChildren()[0].getContext().read<::zserio::StdIntArrayTraits<uint8_t>>(in), allocator);
    case 16:
        return ::zserio::AnyHolder<>(contextNode.getChildren()[1].getContext().read<::zserio::StdIntArrayTraits<uint16_t>>(in), allocator);
    case 32:
        return ::zserio::AnyHolder<>(contextNode.getChildren()[2].getContext().read<::zserio::StdIntArrayTraits<uint32_t>>(in), allocator);
    case 64:
        return ::zserio::AnyHolder<>(contextNode.getChildren()[3].getContext().read<::zserio::StdIntArrayTraits<uint64_t>>(in), allocator);
    default:
        return ::zserio::AnyHolder<>(allocator);
    }
}
