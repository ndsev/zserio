...
// new in cpp11
Structure::Structure(uint32_t _size, const Array& _array, bool _hasExtra,
        const zserio::OptionalHolder<uint32_t>& _extraSize, const zserio::OptionalHolder<Array>& _extraArray,
        const String& _str, const zserio::OptionalHolder<Structure>& _recursive)
:   m_size(_size), m_array(_array), m_hasExtra(_hasExtra), m_extraSize(_extraSize),
    m_extraArray(_extraArray),
    m_str(_str), m_recursive(_recursive)
{
}

Structure::Structure(uint32_t _size, Array&& _array, bool _hasExtra,
        const zserio::OptionalHolder<uint32_t>& _extraSize, const zserio::OptionalHolder<Array>& _extraArray,
        const String& _str, const zserio::OptionalHolder<Structure>& _recursive)
:   m_size(_size), m_array(std::move(_array)), m_hasExtra(_hasExtra), m_extraSize(_extraSize),
    m_extraArray(_extraArray),
    m_str(_str), m_recursive(_recursive)
{
}
...
Structure::Structure(uint32_t _size, Array&& _array, bool _hasExtra,
        const zserio::OptionalHolder<uint32_t>& _extraSize, zserio::OptionalHolder<Array>&& _extraArray,
        const String& _str, const zserio::OptionalHolder<Structure>& _recursive)
:   m_size(_size), m_array(std::move(_array)), m_hasExtra(_hasExtra), m_extraSize(_extraSize),
...
Structure::Structure(uint32_t _size, Array&& _array, bool _hasExtra,
        const zserio::OptionalHolder<uint32_t>& _extraSize, zserio::OptionalHolder<Array>&& _extraArray,
        String&& _str, const zserio::OptionalHolder<Structure>& _recursive)
:   m_size(_size), m_array(std::move(_array)), m_hasExtra(_hasExtra), m_extraSize(_extraSize),
    m_extraArray(std::move(_extraArray)),
    m_str(std::move(_str)), m_recursive(_recursive)
{
}

Structure::Structure(uint32_t _size, Array&& _array, bool _hasExtra,
        const zserio::OptionalHolder<uint32_t>& _extraSize, zserio::OptionalHolder<Array>&& _extraArray,
        String&& _str, zserio::OptionalHolder<Structure>&& _recursive)
:   m_size(_size), m_array(std::move(_array)), m_hasExtra(_hasExtra), m_extraSize(_extraSize),
    m_extraArray(std::move(_extraArray)),
    m_str(std::move(_str)), m_recursive(std::move(_recursive))
{
...
Structure::Structure(uint32_t _size, const Array& _array, bool _hasExtra,
        const zserio::OptionalHolder<uint32_t>& _extraSize, const zserio::OptionalHolder<Array>& _extraArray,
        const String& _str, zserio::OptionalHolder<Structure>&& _recursive)
:   m_size(_size), m_array(_array), m_hasExtra(_hasExtra), m_extraSize(_extraSize),
    m_extraArray(_extraArray),
    m_str(_str), m_recursive(std::move(_recursive))
{
}
