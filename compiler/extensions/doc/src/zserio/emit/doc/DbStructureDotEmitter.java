...
class DbStructureDotEmitter extends DotDefaultEmitter
{
    ...
    public void endRoot(Root root) throws ZserioEmitException
    {
        ...
        for (SqlDatabaseType database : databaseList)
        {
            ...
            final File outputDotFile = new File(getOutputPathName(), DB_STRUCTURE_DOT_DIRECTORY +
                    File.separator + database.getName() + DOT_FILE_EXTENSION);
            final File outputSvgFile = new File(getOutputPathName(), DB_STRUCTURE_DOT_DIRECTORY +
