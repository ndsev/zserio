...
public class PackageOverviewEmitter extends DefaultHtmlEmitter
{
    private final Set<String> packages = new TreeSet<String>();


    public PackageOverviewEmitter(String outputPath)
    {
        super(outputPath);
    }
    ...
    public void endRoot(Root root) throws ZserioEmitException
    {
        try
        {
            Template tpl = cfg.getTemplate("doc/package_overview.html.ftl");
