...
<#if withCodeComments>
    ...
    public java.util.List<${rowName}> read(<#if needsParameterProvider>ParameterProvider parameterProvider,</#if>
            java.util.List<java.lang.String> colNames) throws java.sql.SQLException, java.io.IOException
    {
...
<#if withCodeComments>
    ...
    public java.util.List<${rowName}> read(<#if needsParameterProvider>ParameterProvider parameterProvider,</#if>
            java.util.List<java.lang.String> colNames, java.lang.String condition) throws java.sql.SQLException, java.io.IOException
    {
        // assemble sql query
...
<#if withWriterCode>
    ...
    {
        // assemble sql query
        final boolean[] columns = createColumnMapping(null);
    ...
    public void update(${rowName} row, java.util.List<java.lang.String> colNames, java.lang.String whereCondition)
            throws java.sql.SQLException, java.io.IOException
    {
        // assemble sql query
        final boolean[] columns = createColumnMapping(colNames);
...
<#if withValidationCode>
    ...
    private boolean[] createColumnMapping(java.util.List<java.lang.String> colNames)
    {
        boolean[] map = new boolean[columnNames.length];
        for (int i = 0; i < columnNames.length; ++i)
        {
            if (colNames == null || colNames.indexOf(columnNames[i]) >= 0)
                map[i] = true;
            else
                map[i] = false;
        }
