...
public class PositivenessProvider
{
    public PositivenessProvider(zserio_runtime.PubSubInterface client)
    {
        this.client = client;
    }

    public void publishPositiveness(pubsub_poc.BoolValue zserioObject)
    {
        publishPositiveness(zserioObject, null);
    }

    public void publishPositiveness(pubsub_poc.BoolValue zserioObject, Object context)
    {
        publishZserioObject("pubsub/boolean/positiveness", zserioObject, context);
    }
