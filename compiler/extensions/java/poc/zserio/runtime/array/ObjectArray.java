...
public class ObjectArray<E extends SizeOf> implements Array<E>
{
     ...
     */
    public ObjectArray(BitStreamReader reader, int length, ElementFactory<E> factory,
            OffsetChecker checker) throws IOException, ZserioError, Exception
    {
    ...
    private void readAll(BitStreamReader reader, ElementFactory<E> factory) throws IOException, ZserioError, Exception
    {
        long bitPosition = 0;
        int index = 0;
