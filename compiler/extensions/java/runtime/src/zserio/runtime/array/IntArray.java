 ...
 */
public class IntArray extends IntArrayBase
{
    /**
     ...
     */
    public IntArray(BitStreamReader reader, int length, int numBits) throws IOException, ZserioError
    {
     ...
     */
    public IntArray(BitStreamReader reader, int length, int numBits, OffsetChecker checker)
    ...
    {
        return new IntArray(data, offset, length);
    }
    ...
    {
        return (int)reader.readSignedBits(numBits);
    }
            ...
            throws IOException, ZserioError
    {
        ...
        for (int index = 0; index < data.length; index++)
        {
            ...
            data[index] = (int)reader.readSignedBits(numBits);
        }
    }
}
