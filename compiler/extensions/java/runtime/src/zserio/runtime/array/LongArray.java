...
/**
 * Implements Zserio zserio int64 and int:33...int:64 arrays.
 *
 * Zserio int64 and int:33...int:64 arrays are mapped to Java long[] type.
 */
public class LongArray extends LongArrayBase
{
    /**
    ...
    {
        final LongArray result = new LongArray(data.length);
    ...
    {
        return new LongArray(data, offset, length);
    }
            ...
            throws IOException, ZserioError
    {
        ...
        for (int index = 0; index < data.length; index++)
        {
            ...
            data[index] = reader.readSignedBits(numBits);
        }
    }
}
