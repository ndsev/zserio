...
/**
 * Implements Zserio zserio int16 and int:9...int:16 arrays.
 *
 * Zserio int16 and int:9...int:16 arrays are mapped to Java short[] type.
 */
public class ShortArray extends ShortArrayBase
{
    /**
     ...
     */
    public ShortArray(BitStreamReader reader, int length, int numBits) throws IOException, ZserioError
    {
     ...
     */
    public ShortArray(BitStreamReader reader, int length, int numBits, OffsetChecker checker)
    ...
    {
        final ShortArray result = new ShortArray(data.length);
    ...
    {
        return new ShortArray(data, offset, length);
    }
    ...
    {
        return (short)reader.readSignedBits(numBits);
    }
            ...
            throws IOException, ZserioError
    {
        ...
        for (int index = 0; index < length; index++)
        {
            ...
            data[index] = (short)reader.readSignedBits(numBits);
        }
    }
}
