...
/**
 * Implements Zserio zserio uint32 and bit:17...bit:32 arrays.
 *
 * Zserio uint32 and bit:17...bit:32 arrays are mapped to Java long[] type.
 */
public class UnsignedIntArray extends LongArrayBase
{
    /**
     ...
     */
    public UnsignedIntArray(BitStreamReader reader, int length, int numBits) throws IOException, ZserioError
    {
     ...
     */
    public UnsignedIntArray(BitStreamReader reader, int length, int numBits, OffsetChecker checker)
    ...
    {
        final UnsignedIntArray result = new UnsignedIntArray(data.length);
    ...
    {
        return new UnsignedIntArray(data, offset, length);
    }
