...
/**
 * Implements Zserio zserio varint16 arrays.
 *
 * Zserio varint16 arrays are mapped to Java short[] type.
 */
public class VarInt16Array extends ShortArrayBase
{
    /**
     ...
     */
    public VarInt16Array(int length)
    {
        super(length);
    }
     ...
     */
    public VarInt16Array(short[] data, int offset, int length)
    {
    ...
    {
        final VarInt16Array result = new VarInt16Array(data.length);
    ...
    {
        return new VarInt16Array(data, offset, length);
    }

    @Override
    public boolean equals(Object obj)
    {
        if (obj instanceof VarInt16Array)
        {
    ...
    public void writeAligned(BitStreamWriter writer, OffsetChecker checker) throws IOException, ZserioError
    {
        for (int index = 0; index < data.length; index++)
        {
            ...
            writer.writeVarInt16(data[index]);
        }
    }
    ...
    public int bitSizeOf(long bitPosition)
    {
        ...
        for (short value : data)
            endBitPosition += BitSizeOfCalculator.getBitSizeOfVarInt16(value);
            ...
            throws IOException, ZserioError
    {
        ...
        for (int index = 0; index < length; index++)
        {
            ...
            data[index] = reader.readVarInt16();
        }
    }
}
