...
/**
 * Implements Zserio zserio varint32 arrays.
 *
 * Zserio varint32 arrays are mapped to Java int[] type.
 */
public class VarInt32Array extends IntArrayBase
{
    /**
     ...
     */
    public VarInt32Array(BitStreamReader reader, int length) throws IOException, ZserioError
    {
     ...
     */
    public VarInt32Array(BitStreamReader reader, int length, OffsetChecker checker)
     ...
     */
    public VarInt32Array(int length)
    {
        super(length);
    }
     ...
     */
    public VarInt32Array(int[] data, int offset, int length)
    {
    ...
    {
        final VarInt32Array result = new VarInt32Array(data.length);
    ...
    {
        return new VarInt32Array(data, offset, length);
    }

    @Override
    public boolean equals(Object obj)
    {
        if (obj instanceof VarInt32Array)
        {
    ...
    public void writeAligned(BitStreamWriter writer, OffsetChecker checker) throws IOException, ZserioError
    {
        for (int index = 0; index < data.length; index++)
        {
            ...
            writer.writeVarInt32(data[index]);
        }
    }
    ...
    public int bitSizeOf(long bitPosition)
    {
        ...
        for (int value : data)
            endBitPosition += BitSizeOfCalculator.getBitSizeOfVarInt32(value);
    ...
    public long initializeOffsetsAligned(long bitPosition, OffsetSetter setter)
    {
        ...
        for (int index = 0; index < data.length; index++)
        {
            ...
            currentBitPosition += BitSizeOfCalculator.getBitSizeOfVarInt32(data[index]);
        }
            ...
            throws IOException, ZserioError
    {
        ...
        for (int index = 0; index < length; index++)
        {
            ...
            data[index] = reader.readVarInt32();
        }
    }
}
