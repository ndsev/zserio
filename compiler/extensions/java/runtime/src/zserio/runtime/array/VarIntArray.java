...
/**
 * Implements Zserio varint arrays.
 *
 * Zserio varint arrays are mapped to Java long[] type.
 */
public class VarIntArray extends LongArrayBase
{
    /**
     ...
     */
    public VarIntArray(BitStreamReader reader, int length) throws IOException, ZserioError
    {
     ...
     */
    public VarIntArray(BitStreamReader reader, int length, OffsetChecker checker)
     ...
     */
    public VarIntArray(long[] data, int offset, int length)
    {
    ...
    {
        final VarIntArray result = new VarIntArray(data.length);
    ...
    {
        return new VarIntArray(data, offset, length);
    }

    @Override
    public boolean equals(Object obj)
    {
        if (obj instanceof VarIntArray)
        {
    ...
    public int bitSizeOf(long bitPosition)
    {
        ...
        for (long value : data)
            endBitPosition += BitSizeOfCalculator.getBitSizeOfVarInt(value);
    ...
    public long initializeOffsetsAligned(long bitPosition, OffsetSetter setter)
    {
        ...
        for (int index = 0; index < data.length; index++)
        {
            ...
            currentBitPosition += BitSizeOfCalculator.getBitSizeOfVarInt(data[index]);
        }
