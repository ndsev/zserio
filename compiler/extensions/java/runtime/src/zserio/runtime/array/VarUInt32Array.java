 ...
 * <p>
 * <b>Note:</b> Zserio varuint32 type can hold only 29-bits unsigned value at maximum (for more information about
 * variable integer format, please consult the chapter 3.4 in Zserio Language Overview). Therefore
 * mapping to Java int type is enough (Java int type can address 29-bits unsigned value).
 * </p>
 */
public class VarUInt32Array extends IntArrayBase
{
    /**
     ...
     */
    public VarUInt32Array(int length)
    {
        super(length);
    }
     ...
     */
    public VarUInt32Array(int[] data, int offset, int length)
    {
    ...
    {
        final VarUInt32Array result = new VarUInt32Array(data.length);
    ...
    {
        return new VarUInt32Array(data, offset, length);
    }

    @Override
    public boolean equals(Object obj)
    {
        if (obj instanceof VarUInt32Array)
        {
    ...
    public void writeAligned(BitStreamWriter writer, OffsetChecker checker) throws IOException, ZserioError
    {
        for (int index = 0; index < data.length; index++)
        {
            ...
            writer.writeVarUInt32(data[index]);
        }
    }
    ...
    public int bitSizeOf(long bitPosition)
    {
        ...
        for (int value : data)
            endBitPosition += BitSizeOfCalculator.getBitSizeOfVarUInt32(value);
            ...
            throws IOException, ZserioError
    {
        ...
        for (int index = 0; index < length; index++)
        {
            ...
            data[index] = reader.readVarUInt32();
        }
    }
}
