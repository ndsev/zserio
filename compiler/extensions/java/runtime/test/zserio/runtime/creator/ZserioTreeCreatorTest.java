...
public class ZserioTreeCreatorTest
{
    ...
    public void createObjectFull()
    {
        ...
        creator.setValue("dummyBitmask", DummyBitmask.WRITE);
        creator.endCompound();
        ...
        creator.setValue("dummyBitmask", DummyBitmask.READ);
        ...
        assertEquals(DummyBitmask.WRITE, dummyObject.getNested().getDummyBitmask());
        ...
        assertEquals(DummyBitmask.READ, dummyObject.getNestedArray()[0].getDummyBitmask());
