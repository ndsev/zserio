...
class PositivenessProvider:
    def __init__(self, client):
        self._client = client # PubSubClient interface

        self._subscribersInt32Value = {}

    def publishPositiveness(self, zserioObject, context=None):
        self._publishZserioObject("pubsub/boolean/positiveness", zserioObject, context)
