...
def to_debug_stream(obj: typing.Any, text_io: typing.TextIO, *, indent: typing.Union[None, int, str] = 4,
...
def to_debug_string(obj: typing.Any, *, indent: typing.Union[None, int, str] = 4,
    ...
    :returns: Debug string in JSON.
    """

    text_io = io.StringIO()
    to_debug_stream(obj, text_io, indent=indent, walk_filter=walk_filter)
    return text_io.getvalue()

def to_debug_file(obj: typing.Any, filename: str, *, indent: typing.Union[None, int, str] = 4,
                  walk_filter: typing.Optional[WalkFilter] = None) -> None:
    """
