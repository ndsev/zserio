...
class ArrayTest(unittest.TestCase):
    ...
    def test_bitbuffer_array(self):
        ...
        array1_values = [
            BitBuffer(bytes([0xAB, 0xE0]), 11),
            BitBuffer(bytes([0xAB, 0xCD, 0xFE]), 23),
        ]
        array1_bitsizeof = 8 + 11 + 8 + 23
        array1_aligned_bitsizeof = 8 + 11 + 5 + 8 + 23
        array2_values = [
            BitBuffer(bytes([0xBA, 0xE0]), 11),
            BitBuffer(bytes([0xBA, 0xDC, 0xFE]), 23),
        ]
        self._test_array(
            array_traits,
            array1_values,
    ...
    def test_bitfield_packed_array(self):
        ...
        array1_aligned_bitsizeof = self._calc_aligned_packed_bit_size(
            64, len(array1_values), array1_max_delta_bit_size
        )
        ...
        array5_values = [
            ...
            30,
            40,
        ]  # max_bit_number 8, delta needs 9 bits
        ...
        array6_values = [
            ...
            30,
            40,
        ]  # max_bit_number 7, delta needs 8 bits
    ...
    def test_signed_bitfield_packed_array(self):
        ...
        array16_values = [
            ...
            30,
            40,
        ]  # max_bit_number 15, delta needs 16 bits
    ...
    def _test_packed_array(
        ...
        auto_aligned_bitsize = (
            auto_size_bitsize + array_aligned_bitsizeof if array_aligned_bitsizeof is not None else None
        )
    ...
    def _calc_aligned_packed_bit_size(self, element_bit_size, array_size, max_delta_bit_size):
        ...
        return (
            aligned_first_element_with_descriptor_bit_size
            + (array_size - 2) * aligned_max_delta_bit_size
            + (max_delta_bit_size + 1)
        )
