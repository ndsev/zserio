...
class HashCodeTest(unittest.TestCase):
    ...
    def test_float32_type(self):
        hash_seed = 1
        float_value = 10.0
        self.assertEqual(HASH_PRIME_NUMBER + float_to_uint32(float_value),
    ...
    def test_float64_type(self):
        ...
        expected_hash_code = ((HASH_PRIME_NUMBER +
                              ((uint64_value & 0xFFFFFFFF) ^ ((uint64_value & 0xFFFFFFFFFFFFFFFF) >> 32)))
                              & 0xFFFFFFFF)
    ...
    def test_enum_type(self):
        hash_seed = 1
        self.assertEqual(HASH_PRIME_NUMBER + (HASH_PRIME_NUMBER * HASH_SEED + Color.NONE.value),
                         calc_hashcode_object(hash_seed, Color.NONE))
        self.assertEqual(HASH_PRIME_NUMBER + (HASH_PRIME_NUMBER * HASH_SEED + Color.RED.value),
                         calc_hashcode_object(hash_seed, Color.RED))
        self.assertEqual(HASH_PRIME_NUMBER + (HASH_PRIME_NUMBER * HASH_SEED + Color.BLUE.value),
                         calc_hashcode_object(hash_seed, Color.BLUE))
        self.assertEqual(HASH_PRIME_NUMBER + (HASH_PRIME_NUMBER * HASH_SEED + Color.BLACK.value),
                         calc_hashcode_object(hash_seed, Color.BLACK))

    def test_bitmask_type(self):
        hash_seed = 1
        self.assertEqual(HASH_PRIME_NUMBER +
                         (HASH_PRIME_NUMBER * HASH_SEED + Permissions.Values.READ.value),
                         calc_hashcode_object(hash_seed, Permissions.Values.READ))
        self.assertEqual(HASH_PRIME_NUMBER +
                         (HASH_PRIME_NUMBER * HASH_SEED + Permissions.Values.WRITE.value),
                         calc_hashcode_object(hash_seed, Permissions.Values.WRITE))
        self.assertEqual(HASH_PRIME_NUMBER +
                         (HASH_PRIME_NUMBER * HASH_SEED + Permissions.Values.CREATE.value),
    ...
    def test_array_type(self):
        ...
        self.assertEqual(HASH_PRIME_NUMBER + raw_array_hash_code, calc_hashcode_object(hash_seed, array_value))

    def test_bool_array_type(self):
        hash_seed = 1
        bool_array_value = [ False, True ]
        self.assertEqual((HASH_PRIME_NUMBER + 0) * HASH_PRIME_NUMBER + 1,
    ...
    def test_int_array_type(self):
        hash_seed = 1
        int_array_value = [ 3, 7 ]
        self.assertEqual((HASH_PRIME_NUMBER + 3) * HASH_PRIME_NUMBER + 7,
    ...
    def test_float32_array_type(self):
        ...
        self.assertEqual(HASH_PRIME_NUMBER + float_to_uint32(float32_array_value[0]),
    ...
    def test_str_array_type(self):
        hash_seed = 1
        str_array_value = [ '0' ]
        self.assertEqual(HASH_PRIME_NUMBER + ord(str_array_value[0]),
    ...
    def test_bitmask_array_type(self):
        ...
        self.assertEqual(HASH_PRIME_NUMBER + (HASH_PRIME_NUMBER * HASH_SEED + Permissions.Values.READ.value),
