...
class ArrayHolder:
    def __init__(
        ...
        self._enum_array_ = zserio.array.Array(
            zserio.array.ObjectArrayTraits(self._ZserioElementFactory_enum_array()), enum_array_, is_auto=True
        )
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._enum_array_ = zserio.array.Array.from_reader_packed(
            zserio.array.ObjectArrayTraits(self._ZserioElementFactory_enum_array()), zserio_reader, is_auto=True
        )
    ...
    class _ZserioElementFactory_enum_array:
        ...
        @staticmethod
        def create_packed(
            zserio_context: zserio.array.DeltaContext, zserio_reader: zserio.BitStreamReader, zserio_index: int
        ) -> test_object.array_enum.ArrayEnum:
            del zserio_index
