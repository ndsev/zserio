...
class ArrayObject:
    ...
    def read_packed(
        self, zserio_context: ArrayObject.ZserioPackingContext, zserio_reader: zserio.BitStreamReader
    ) -> None:
    ...
    def write_packed(
        self, zserio_context: ArrayObject.ZserioPackingContext, zserio_writer: zserio.BitStreamWriter
    ) -> None:
