...
class CreatorNested:
    ...
    @classmethod
    def from_reader(
        cls: typing.Type["CreatorNested"], zserio_reader: zserio.BitStreamReader, param_: int
    ) -> "CreatorNested":
    ...
    def creator_bitmask(
        self, creator_bitmask_: typing.Union[test_object.creator_bitmask.CreatorBitmask, None]
    ) -> None:
        self._creator_bitmask_ = creator_bitmask_
