...
class SerializeNested:
    def __init__(self, param_: int, offset_: int = int(), optional_value_: typing.Optional[int] = None) -> None:
        self._param_ = param_
    ...
    @classmethod
    def from_reader(
        cls: typing.Type["SerializeNested"], zserio_reader: zserio.BitStreamReader, param_: int
    ) -> "SerializeNested":
        ...
        if self.is_optional_value_used():
            ...
            if zserio_reader.bitposition != zserio.bitposition.bytes_to_bits(self._offset_):
                raise zserio.PythonRuntimeException(
                    ...
                    "{0} != {1}!".format(
                        {zserio_reader.bitposition}, zserio.bitposition.bytes_to_bits(self._offset_)
                    )
                )
        ...
        if self.is_optional_value_used():
            ...
            if zserio_writer.bitposition != zserio.bitposition.bytes_to_bits(self._offset_):
                raise zserio.PythonRuntimeException(
                    "Wrong offset for field SerializeNested.optionalValue: "
                    "{0} != {1}!".format(
                        {zserio_writer.bitposition}, zserio.bitposition.bytes_to_bits(self._offset_)
                    )
                )
