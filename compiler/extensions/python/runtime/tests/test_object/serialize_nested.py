...
class SerializeNested:
        ...
        field_list: typing.List[zserio.typeinfo.MemberInfo] = [
            ...
            zserio.typeinfo.MemberInfo(
                ...
                attributes={
                    ...
                    zserio.typeinfo.MemberAttribute.OFFSET : (lambda self, zserio_index: self.offset),
                    zserio.typeinfo.MemberAttribute.OPTIONAL : (lambda self: self.param >= 0),
    ...
    def init_packing_context(self, zserio_context_node: zserio.array.PackingContextNode) -> None:
        if self.is_optional_value_used():
            zserio_context_node.children[1].context.init(zserio.array.BitFieldArrayTraits(32), self._optional_value_)
    ...
    def bitsizeof_packed(self, zserio_context_node: zserio.array.PackingContextNode,
        ...
        if self.is_optional_value_used():
            end_bitposition = zserio.bitposition.alignto(8, end_bitposition)
            end_bitposition += zserio_context_node.children[1].context.bitsizeof(zserio.array.BitFieldArrayTraits(32), self._optional_value_)
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        if self.is_optional_value_used():
            ...
            # check offset
            if zserio_reader.bitposition != zserio.bitposition.bytes_to_bits(self.offset):
                raise zserio.PythonRuntimeException("Wrong offset for field SerializeNested.optionalValue: "
                                                    f"{zserio_reader.bitposition} != {zserio.bitposition.bytes_to_bits(self.offset)}!")
    ...
    def read_packed(self, zserio_context_node: zserio.array.PackingContextNode,
        ...
        if self.is_optional_value_used():
            ...
            if zserio_reader.bitposition != zserio.bitposition.bytes_to_bits(self.offset):
                raise zserio.PythonRuntimeException("Wrong offset for field SerializeNested.optionalValue: "
                                                    f"{zserio_reader.bitposition} != {zserio.bitposition.bytes_to_bits(self.offset)}!")
            self._optional_value_ = zserio_context_node.children[1].context.read(zserio.array.BitFieldArrayTraits(32), zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self.is_optional_value_used():
            ...
            # check offset
            if zserio_writer.bitposition != zserio.bitposition.bytes_to_bits(self.offset):
                raise zserio.PythonRuntimeException("Wrong offset for field SerializeNested.optionalValue: "
                                                    f"{zserio_writer.bitposition} != {zserio.bitposition.bytes_to_bits(self.offset)}!")
    ...
    def write_packed(self, zserio_context_node: zserio.array.PackingContextNode,
        ...
        if self.is_optional_value_used():
            ...
            if zserio_writer.bitposition != zserio.bitposition.bytes_to_bits(self.offset):
                raise zserio.PythonRuntimeException("Wrong offset for field SerializeNested.optionalValue: "
                                                    f"{zserio_writer.bitposition} != {zserio.bitposition.bytes_to_bits(self.offset)}!")
            zserio_context_node.children[1].context.write(zserio.array.BitFieldArrayTraits(32), zserio_writer, self._optional_value_)
