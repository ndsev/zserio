...
class WalkerObject:
        ...
        field_list: typing.List[zserio.typeinfo.MemberInfo] = [
            ...
            zserio.typeinfo.MemberInfo(
                ...
                attributes={
                    ...
                    zserio.typeinfo.MemberAttribute.OPTIONAL : (lambda self: self.identifier != 0),
    ...
    def init_packing_context(self, zserio_context_node: zserio.array.PackingContextNode) -> None:
        zserio_context_node.children[0].context.init(zserio.array.BitFieldArrayTraits(32), self._identifier_)
        if self.is_nested_used():
    ...
    def bitsizeof_packed(self, zserio_context_node: zserio.array.PackingContextNode,
        ...
        end_bitposition = bitposition
        end_bitposition += zserio_context_node.children[0].context.bitsizeof(zserio.array.BitFieldArrayTraits(32), self._identifier_)
        if self.is_nested_used():
    ...
    def read_packed(self, zserio_context_node: zserio.array.PackingContextNode,
        ...
        self._identifier_ = zserio_context_node.children[0].context.read(zserio.array.BitFieldArrayTraits(32), zserio_reader)
    ...
    def write_packed(self, zserio_context_node: zserio.array.PackingContextNode,
        ...
        zserio_context_node.children[0].context.write(zserio.array.BitFieldArrayTraits(32), zserio_writer, self._identifier_)
