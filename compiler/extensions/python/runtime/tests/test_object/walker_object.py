...
class WalkerObject:
    ...
    def read_packed(self, zserio_context: WalkerObject.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._union_array_ = zserio.array.Array.from_reader_packed(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_union_array()), zserio_reader, is_auto=True)

        if zserio_reader.read_bool():
            self._optional_union_array_ = zserio.array.Array.from_reader_packed(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_optional_union_array()), zserio_reader, is_auto=True)
        else:
            self._optional_union_array_ = None
