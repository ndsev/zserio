...
class WalkerObject:
    def __init__(
        ...
        self._union_array_ = zserio.array.Array(
            zserio.array.ObjectArrayTraits(self._ZserioElementFactory_union_array()), union_array_, is_auto=True
        )
    ...
    def optional_union_array(
        self, optional_union_array_: typing.Optional[typing.List[test_object.walker_union.WalkerUnion]]
    ) -> None:
        if optional_union_array_ is None:
            self._optional_union_array_ = None
        else:
