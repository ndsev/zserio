...
Binary data streams defined by zserio are also good candidates to be used in RPC systems. Zserio introduces RPC services directly in the language.
...
However parameterized types can be still used in the response or request type subtree. Currently only unary
RPCs are supported by zserio.

Code generated by zserio is the same as the code generated by
