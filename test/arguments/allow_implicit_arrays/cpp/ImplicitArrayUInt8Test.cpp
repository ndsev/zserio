...
const std::string ImplicitArrayUInt8Test::BLOB_NAME =
        "arguments/allow_implicit_arrays/implicit_array_uint8.blob";
...
TEST_F(ImplicitArrayUInt8Test, writeRead)
{
    const size_t numElements = 55;
    vector_type<uint8_t> array;
    array.reserve(numElements);
...
TEST_F(ImplicitArrayUInt8Test, writeReadFile)
{
    const size_t numElements = 55;
    vector_type<uint8_t> array;
    array.reserve(numElements);
