...
class WithoutWriterCodeTest(unittest.TestCase):
    ...
    def testItemMethods(self):
        ...
        self._assertMethodPresent(userType, "hasExtraParam")
    ...
    def testTileMethods(self):
        ...
        self._assertMethodPresent(userType, "hasVersion")
        self._assertMethodPresent(userType, "hasVersionString")
