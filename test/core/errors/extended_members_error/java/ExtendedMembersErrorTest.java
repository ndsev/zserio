...
public class ExtendedMembersErrorTest
{
    ...
    {
        final String errors[] = {"extended_deep_nested_error.zs:6:19:     extended field used here",
    ...
    {
        final String errors[] = {"extended_in_recursion_error.zs:7:19:     extended field used here",
    ...
    {
        final String errors[] = {"extended_multiple_not_last_error.zs:6:19:     extended field used here",
    ...
    {
        final String errors[] = {"extended_nested_in_array_error.zs:6:19:     extended field used here",
    ...
    {
        final String errors[] = {"extended_nested_in_choice_error.zs:6:19:     extended field used here",
    ...
    {
        final String errors[] = {"extended_nested_in_union_error.zs:6:19:     extended field used here",
    ...
    {
        final String errors[] = {"extended_not_last_error.zs:6:19:     extended field used here",
    ...
    {
        final String errors[] = {"extended_not_last_in_template_error.zs:10:13: "
    ...
    {
        final String errors[] = {"extended_not_top_level_error.zs:6:19:     extended field used here",
