...
public class BitmaskTypesErrorTest
{
    ...
    {
        final String error = "bitmask_type_value_error.zs:7:18: Bitmask value 'WRITE' is not an integral type!";
    ...
    {
        final String errors[] = {"duplicated_bitmask_value_name_error.zs:6:5:     First defined here",
