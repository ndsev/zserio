...
class InnerClassesClashingErrorTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        compileErroneousZserio(
            __file__, "inner_classes_clashing/bitmask_values_class_clash_error.zs", cls.errors
        )
        compileErroneousZserio(
            __file__, "inner_classes_clashing/sql_table_i_parameter_provider_class_clash_error.zs", cls.errors
        )
        compileErroneousZserio(
            __file__, "inner_classes_clashing/sql_table_rows_class_clash_error.zs", cls.errors
        )
