...
class EnumerationTypeTest(Expressions.TestCase):
    def testBitSizeOfWithOptional(self):
        ...
        self.assertEqual(
            self.ENUMERATION_TYPE_EXPRESSION_BIT_SIZE_WITH_OPTIONAL, enumerationTypeExpression.bitsizeof()
        )
    ...
    def testBitSizeOfWithoutOptional(self):
        ...
        self.assertEqual(
            self.ENUMERATION_TYPE_EXPRESSION_BIT_SIZE_WITHOUT_OPTIONAL, enumerationTypeExpression.bitsizeof()
        )
