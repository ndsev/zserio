...
import test_utils.HashTest;
import test_utils.WriteReadTest;
...
public class ExtendedPackedArrayTest
{
    ...
    public void operatorEquality()
    {
        ...
        assertTrue(data.equals(equalData));
    }
    ...
    public void writeReadExtended2()
    {
        ...
        WriteReadTest.run(Extended2.class, data);
    }
    ...
    public void writeExtended1ReadExtended2()
    {
        ...
        WriteReadTest.run(Extended2.class, readDataExtended2);
    }
    ...
    public void stdHash()
    {
        ...
        HashTest.run(data, dataHash, equalData, diffData, diffDataHash);
    }
}
