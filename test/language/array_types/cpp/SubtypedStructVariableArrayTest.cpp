...
TEST_F(SubtypedStructVariableArrayTest, read)
{
    ...
    const std::vector<ArrayElement>& compoundArray = subtypedStructVariableArray.getCompoundArray();
...
TEST_F(SubtypedStructVariableArrayTest, write)
{
    ...
    const std::vector<ArrayElement>& readCompoundArray = readSubtypedStructVariableArray.getCompoundArray();
...
TEST_F(SubtypedStructVariableArrayTest, writeWrongArray)
{
    ...
    SubtypedStructVariableArray subtypedStructVariableArray;
    subtypedStructVariableArray.setNumElements(static_cast<uint8_t>(numElements + 1));
    subtypedStructVariableArray.setCompoundArray(compoundArray);
