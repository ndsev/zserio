...
#include "array_types/subtyped_builtin_auto_array/ArrayElement.h"
...
protected:
    ...
    void checkBitSizeOf(size_t numElements)
    {
        ...
        ASSERT_EQ(autoArrayBitSize, subtypedBuiltinAutoArray.bitSizeOf(bitPosition));
    }
    ...
    void checkRead(size_t numElements)
    {
        ...
        const zserio::UInt8Array& array = subtypedBuiltinAutoArray.getArray();
    ...
    void checkWrite(size_t numElements)
    {
        ...
        const zserio::UInt8Array& readArray = readSubtypedBuiltinAutoArray.getArray();
