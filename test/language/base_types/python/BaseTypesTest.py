...
class BaseTypesTest(unittest.TestCase):
    ...
    def testVariableBitField8Type(self):
        ...
        self.assertEqual(maxVariableBitfield8Type, baseTypes.getVariableBitfield8Type())
    ...
    def testVariableIntField8Type(self):
        baseTypes = self.api.BaseTypes()
        baseTypes.setVariableIntfield8Type(zserio.limits.INT8_MAX)
        self.assertEqual(zserio.limits.INT8_MAX, baseTypes.getVariableIntfield8Type())
    ...
    def testExternType(self):
        baseTypes = self.api.BaseTypes()
        testExtern = zserio.bitbuffer.BitBuffer(bytes([0xCD, 0x03]), 10)
        baseTypes.setExternType(testExtern)
        self.assertEqual(testExtern, baseTypes.getExternType())

    def testBitSizeOf(self):
        baseTypes = self.api.BaseTypes()
        baseTypes.setBoolType(True)
        baseTypes.setUint8Type(1)
        baseTypes.setUint16Type(zserio.limits.UINT16_MAX)
        baseTypes.setUint32Type(zserio.limits.UINT32_MAX)
        baseTypes.setUint64Type(zserio.limits.UINT64_MAX)
        baseTypes.setInt8Type(zserio.limits.INT8_MAX)
        ...
        baseTypes.setInt32Type(zserio.limits.INT32_MAX)
        baseTypes.setInt64Type(zserio.limits.INT64_MAX)
        baseTypes.setBitfield7Type(0x7F)
        baseTypes.setBitfield8Type(zserio.limits.UINT8_MAX)
        baseTypes.setBitfield15Type(0x7FFF)
        baseTypes.setBitfield16Type(zserio.limits.UINT16_MAX)
        baseTypes.setBitfield31Type(0x7FFFFFFF)
        baseTypes.setBitfield32Type(zserio.limits.UINT32_MAX)
        baseTypes.setBitfield63Type(0x7FFFFFFFFFFFFFFF)
        baseTypes.setVariableBitfieldType(1)
        baseTypes.setVariableBitfield8Type(zserio.limits.UINT8_MAX)
        baseTypes.setIntfield8Type(zserio.limits.INT8_MAX)
        baseTypes.setIntfield16Type(zserio.limits.INT16_MAX)
        baseTypes.setIntfield32Type(zserio.limits.INT32_MAX)
        baseTypes.setIntfield64Type(zserio.limits.INT64_MAX)
        baseTypes.setVariableIntfieldType(1)
        baseTypes.setVariableIntfield8Type(zserio.limits.INT8_MAX)
        baseTypes.setFloat16Type(sys.float_info.max)
        baseTypes.setFloat32Type(sys.float_info.max)
        baseTypes.setFloat64Type(sys.float_info.max)
        ...
        baseTypes.setExternType(zserio.bitbuffer.BitBuffer(bytes([0xCD, 0x03]), 10))
        expectedBitSizeOf = 1102
        self.assertEqual(expectedBitSizeOf, baseTypes.bitSizeOf())

    def testReadWrite(self):
        baseTypes = self.api.BaseTypes()
        baseTypes.setBoolType(True)
        baseTypes.setUint8Type(8)
        baseTypes.setUint16Type(zserio.limits.UINT16_MAX)
        baseTypes.setUint32Type(zserio.limits.UINT32_MAX)
        baseTypes.setUint64Type(zserio.limits.UINT64_MAX)
        baseTypes.setInt8Type(zserio.limits.INT8_MAX)
        ...
        baseTypes.setBitfield32Type(zserio.limits.UINT32_MAX)
        baseTypes.setBitfield63Type(0x7FFFFFFFFFFFFFFF)
        baseTypes.setVariableBitfieldType(zserio.limits.UINT8_MAX)
        baseTypes.setVariableBitfield8Type(zserio.limits.UINT8_MAX)
        baseTypes.setIntfield8Type(zserio.limits.INT8_MAX)
        baseTypes.setIntfield16Type(zserio.limits.INT16_MAX)
        baseTypes.setIntfield32Type(zserio.limits.INT32_MAX)
        baseTypes.setIntfield64Type(zserio.limits.INT64_MAX)
        baseTypes.setVariableIntfieldType(zserio.limits.INT8_MAX)
        baseTypes.setVariableIntfield8Type(zserio.limits.INT8_MAX)
        baseTypes.setFloat16Type(1.0)
        baseTypes.setFloat32Type(1.0)
        baseTypes.setFloat64Type(sys.float_info.max)
        baseTypes.setVaruint16Type(zserio.limits.VARUINT16_MAX)
        baseTypes.setVaruint32Type(zserio.limits.VARUINT32_MAX)
        baseTypes.setVaruint64Type(zserio.limits.VARUINT64_MAX)
        ...
        readBaseTypes = self.api.BaseTypes()
        readBaseTypes.read(reader)
        self.assertEqual(baseTypes, readBaseTypes)
