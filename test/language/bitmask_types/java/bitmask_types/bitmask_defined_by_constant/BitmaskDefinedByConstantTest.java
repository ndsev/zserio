...
public class BitmaskDefinedByConstantTest
{
    @Test
    ...
    {
        assertThrows(IllegalArgumentException.class, () -> new Permission((long)-1));
    }

    @Test
    public void valueConstructorAboveUpperBound()
    {
        assertThrows(IllegalArgumentException.class, () -> new Permission(((long)1 << PERMISSION_BITSIZEOF)));
    }
    ...
    private static int PERMISSION_BITSIZEOF = 32;

    private static long NONE_VALUE = 0;
    private static long READ_VALUE = READ_PERMISSION.READ_PERMISSION;
    private static long WRITE_VALUE = 4;
}
