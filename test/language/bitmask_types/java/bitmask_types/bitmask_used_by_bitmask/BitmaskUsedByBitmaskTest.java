...
public class BitmaskUsedByBitmaskTest
{
    @Test
    ...
    public void toStringMethod()
    {
        ...
        assertEquals("6[READ | WRITE | CREATE]", Permission.Values.READ.or(Permission.Values.WRITE).toString());
        assertEquals("7[READ | WRITE | CREATE]", new Permission((byte)7).toString());
    }
    ...
    private static int PERMISSION_BITSIZEOF = 7;

    private static byte NONE_VALUE = 0;
    private static byte READ_VALUE = SimplePermission.Values.READ.getValue();
    private static byte WRITE_VALUE = SimplePermission.Values.WRITE.getValue();
}
