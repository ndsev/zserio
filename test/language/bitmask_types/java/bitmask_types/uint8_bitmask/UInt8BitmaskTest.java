...
public class UInt8BitmaskTest
{
    ...
    {
        assertThrows(IllegalArgumentException.class, () -> new Permission((short)-1));
    }

    @Test
    public void valueConstructorAboveUpperBound()
    {
        assertThrows(IllegalArgumentException.class, () -> new Permission((short)(1 << PERMISSION_BITSIZEOF)));
    }
    ...
    public void toStringMethod()
    {
        ...
        assertEquals("7[READ | WRITE | CREATE]", new Permission((short)7).toString());
        assertEquals("255[READ | WRITE | CREATE]", new Permission((short)255).toString());
    }
    ...
    private static int PERMISSION_BITSIZEOF = 8;

    private static short NONE_VALUE = 0;
    private static short READ_VALUE = 2;
    private static short WRITE_VALUE = 4;
}
