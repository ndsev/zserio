...
#include "builtin_types/all_builtin_types/AllAllBuiltInTypes.h"
...
class AllAllBuiltInTypesTest : public ::testing::Test
{
protected:
    AllBuiltInTypes   m_AllBuiltInTypes;
};

TEST_F(AllAllBuiltInTypesTest, uint8Type)
{
...
TEST_F(AllAllBuiltInTypesTest, uint16Type)
{
...
TEST_F(AllAllBuiltInTypesTest, uint32Type)
{
...
TEST_F(AllAllBuiltInTypesTest, uint64Type)
{
...
TEST_F(AllAllBuiltInTypesTest, int8Type)
{
...
TEST_F(AllAllBuiltInTypesTest, int16Type)
{
...
TEST_F(AllAllBuiltInTypesTest, int32Type)
{
...
TEST_F(AllAllBuiltInTypesTest, int64Type)
{
...
TEST_F(AllAllBuiltInTypesTest, bitfield7Type)
{
...
TEST_F(AllAllBuiltInTypesTest, bitfield8Type)
{
...
TEST_F(AllAllBuiltInTypesTest, bitfield15Type)
{
...
TEST_F(AllAllBuiltInTypesTest, bitfield16Type)
{
...
TEST_F(AllAllBuiltInTypesTest, bitfield31Type)
{
...
TEST_F(AllAllBuiltInTypesTest, bitfield32Type)
{
...
TEST_F(AllAllBuiltInTypesTest, bitfield63Type)
{
...
TEST_F(AllAllBuiltInTypesTest, variableBitfieldType)
{
...
TEST_F(AllAllBuiltInTypesTest, variableBitfield8Type)
{
    const uint8_t maxBitfield8Type = std::numeric_limits<uint8_t>::max();
    m_AllBuiltInTypes.setBitfield8Type(maxBitfield8Type);
    const uint8_t bitfield8Type = m_AllBuiltInTypes.getBitfield8Type();
...
TEST_F(AllAllBuiltInTypesTest, intfield8Type)
{
...
TEST_F(AllAllBuiltInTypesTest, intfield16Type)
{
...
TEST_F(AllAllBuiltInTypesTest, intfield32Type)
{
...
TEST_F(AllAllBuiltInTypesTest, intfield64Type)
{
...
TEST_F(AllAllBuiltInTypesTest, variableIntfieldType)
{
...
TEST_F(AllAllBuiltInTypesTest, variableIntfield8Type)
{
    const int8_t maxIntfield8Type = std::numeric_limits<int8_t>::max();
    m_AllBuiltInTypes.setIntfield8Type(maxIntfield8Type);
    const int8_t intfield8Type = m_AllBuiltInTypes.getIntfield8Type();
...
TEST_F(AllAllBuiltInTypesTest, float16Type)
{
...
TEST_F(AllAllBuiltInTypesTest, float32Type)
{
...
TEST_F(AllAllBuiltInTypesTest, float64Type)
{
...
TEST_F(AllAllBuiltInTypesTest, varuint16Type)
{
...
TEST_F(AllAllBuiltInTypesTest, varuint32Type)
{
...
TEST_F(AllAllBuiltInTypesTest, varuint64Type)
{
...
TEST_F(AllAllBuiltInTypesTest, varuintTypeMin)
{
...
TEST_F(AllAllBuiltInTypesTest, varint16Type)
{
...
TEST_F(AllAllBuiltInTypesTest, varint32Type)
{
...
TEST_F(AllAllBuiltInTypesTest, varint64Type)
{
...
TEST_F(AllAllBuiltInTypesTest, varintTypeMin)
{
...
TEST_F(AllAllBuiltInTypesTest, boolType)
{
...
TEST_F(AllAllBuiltInTypesTest, stringType)
{
