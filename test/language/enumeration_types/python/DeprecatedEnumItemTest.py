...
class DeprecatedEnumItemTest(EnumerationTypes.TestCase):
    def testValues(self):
        ...
        with self.assertWarns(DeprecationWarning):
            self.assertEqual(HEAVY_VALUE, self.api.Traffic.HEAVY.value)
    ...
    def testFromString(self):
        ...
        with self.assertWarns(DeprecationWarning):
            self.assertEqual(self.api.Traffic.from_name("HEAVY"), self.api.Traffic.HEAVY)
    ...
    def testFromReader(self):
        ...
        with self.assertWarns(DeprecationWarning):
            writer.write_bits(self.api.Traffic.HEAVY.value, TRAFFIC_BIT_SIZE)
    ...
    def testBitSizeOf(self):
        ...
        with self.assertWarns(DeprecationWarning):
            self.assertEqual(TRAFFIC_BIT_SIZE, self.api.Traffic.HEAVY.bitsizeof())
    ...
    def testInitializeOffsets(self):
        ...
        with self.assertWarns(DeprecationWarning):
            self.assertEqual(TRAFFIC_BIT_SIZE + 1, self.api.Traffic.HEAVY.initialize_offsets(1))
    ...
    def testWrite(self):
        ...
        with self.assertWarns(DeprecationWarning):
            self.api.Traffic.HEAVY.write(writer)
        ...
        self.assertEqual(self.api.Traffic.HEAVY, self.api.Traffic.from_reader(reader))
    ...
    def testTypeInfo(self):
        ...
        self.assertEqual("enumeration_types.deprecated_enum_item.Traffic", type_info.schema_name)
        ...
        self.assertEqual(self.api.Traffic.HEAVY, item_info.py_item)
        self.assertTrue(item_info.is_deprecated)
        self.assertFalse(item_info.is_removed)
