...
public class ExplicitSimpleParamTest
{
    ...
    private static class SimpleParamTableParameterProvider implements SimpleParamTable.IParameterProvider
    {
        @Override
    ...
    private static SimpleParamTableRow createSimpleParamTableRow(long id, String name)
    {
        ...
        final UnsignedByteArray values1 = new UnsignedByteArray(SIMPLE_PARAM_TABLE_COUNT1);
        for (int i = 0; i < values1.length(); ++i)
            values1.setElementAt((short)id, i);
        final TestBlob testBlob1 = new TestBlob(values1.length(), values1);
        row.setBlob1(testBlob1);

        final UnsignedByteArray values2 = new UnsignedByteArray(SIMPLE_PARAM_TABLE_COUNT2);
        ...
        final UnsignedByteArray values3 = new UnsignedByteArray(SIMPLE_PARAM_TABLE_COUNT1);
