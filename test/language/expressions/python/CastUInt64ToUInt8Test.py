...
class CastUInt64ToUInt8Test(unittest.TestCase):
    ...
    def testUInt8ValueUsingUInt64Value(self):
        ...
        castUInt64ToUInt8Expression = self.api.CastUInt64ToUInt8Expression.fromFields(uint64Value, False)
    ...
    def testUint8ValueUsingConstant(self):
        uint64Value = 0xFFFFFFFFFFFFFFFE
        castUInt64ToUInt8Expression = self.api.CastUInt64ToUInt8Expression.fromFields(uint64Value, True)
