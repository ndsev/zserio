...
class ParameterTypeTest(Expressions.TestCase):
    def testBitSizeOfWithOptional(self):
        parameterTypeExpression = self.api.ParameterTypeExpression(self.api.Color.RED, self.VALUE, True)
        self.assertEqual(
            self.PARAMETER_TYPE_EXPRESSION_BIT_SIZE_WITH_OPTIONAL, parameterTypeExpression.bitsizeof()
        )
    ...
    def testBitSizeOfWithoutOptional(self):
        ...
        self.assertEqual(
            self.PARAMETER_TYPE_EXPRESSION_BIT_SIZE_WITHOUT_OPTIONAL, parameterTypeExpression.bitsizeof()
        )
