...
protected:
    ...
    {
        const zserio::UInt32Array& offsets = autoIndexedOffsetArray.getOffsets();
    ...
    void checkAutoIndexedOffsetArray(const AutoIndexedOffsetArray& autoIndexedOffsetArray)
    {
        ...
        const zserio::UInt8Array& data = autoIndexedOffsetArray.getData();
        const size_t expectedNumElements = NUM_ELEMENTS;
    ...
    {
        zserio::UInt32Array& offsets = autoIndexedOffsetArray.getOffsets();
        ...
        zserio::UInt8Array& data = autoIndexedOffsetArray.getData();
