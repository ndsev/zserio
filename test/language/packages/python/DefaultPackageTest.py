...
class DefaultPackageTest(unittest.TestCase):
    ...
    def testDefaultPackageStructure(self):
        ...
        structure.setTopStructure(self.api.default_package_import.top.TopStructure.fromFields(1, 1234))
        structure.setChildStructure(self.api.Child.fromFields(0xdeadbeef))
