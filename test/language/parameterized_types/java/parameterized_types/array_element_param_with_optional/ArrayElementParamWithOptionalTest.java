...
public class ArrayElementParamWithOptionalTest
{
    ...
    private void checkHolder(Holder holder)
    {
        ...
        assertEquals(EXTRA_VALUE, holder.getValues()[0].getExtraValue().getValue());
    }

    private static final String BLOB_NAME = "array_element_param_with_optional.blob";
    ...
    private static final int HOLDER_BIT_SIZE = 1 + 7 + BitSizeOfCalculator.getBitSizeOfVarSize(1) + 64;
}
