...
public class ParameterizedInnerClassesClashingTest
{
    ...
    public void writeReadElementFactory() throws IOException, ZserioError
    {
        ...
        final ElementFactory_array testStructure = new ElementFactory_array(param,
            new Compound[] { new Compound(param, 13), new Compound(param, 42) }
        );
    ...
    {
        final long param = 100;
        final ElementInitializer_array testStructure = new ElementInitializer_array(param,
            new Compound[] { new Compound(param, 13), new Compound(param, 42) }
        );
    ...
    {
        final long param = 100;
        final ElementChildrenInitializer_array testStructure = new ElementChildrenInitializer_array(
            new Parent[] {
                new Parent(param, new Compound(param, 13)),
