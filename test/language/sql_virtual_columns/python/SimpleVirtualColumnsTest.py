...
class SimpleVirtualColumnsTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.api = getZserioApi(__file__, "sql_virtual_columns.zs").simple_virtual_columns
        cls._fileName = os.path.join(getApiDir(os.path.dirname(__file__)), "simple_virtual_columns_test.sqlite")
