...
public class StructureInnerClassesClashingTest
{
    ...
    {
        final OffsetChecker_array testStructure = new OffsetChecker_array(new long[4], new long[] {1, 2, 3, 4});
    ...
    {
        final OffsetInitializer_array testStructure =
                new OffsetInitializer_array(new long[4], new long[] {1, 2, 3, 4});
