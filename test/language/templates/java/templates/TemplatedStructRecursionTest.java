...
public class TemplatedStructRecursionTest
{
    ...
    {
        final TemplatedStructRecursion templatedStructRecursion =
                new TemplatedStructRecursion(new RecursiveTemplate_uint32(new long[] {1, 2, 3},
                        new RecursiveTemplate_uint32(
                                new long[] {2, 3, 4}, new RecursiveTemplate_uint32(new long[] {}, null))));
