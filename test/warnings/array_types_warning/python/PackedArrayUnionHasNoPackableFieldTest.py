...
class PackedArrayUnionHasNoPackableFieldTest(ArrayTypesWarning.TestCase):
    ...
    BLOB_NAME = os.path.join(
        getApiDir(os.path.dirname(__file__)), "packed_array_union_has_no_packable_field.blob"
    )
