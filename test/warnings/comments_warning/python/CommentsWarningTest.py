...
class CommentsWarningTest(unittest.TestCase):
    ...
    def testUnusedFieldComments(self):
        assertWarningsPresent(
            self, "comments_warning.zs", ["unused_field_comments.zs:11:11: Documentation comment is not used."]
        )
        assertWarningsPresent(
            self, "comments_warning.zs", ["unused_field_comments.zs:55:45: Documentation comment is not used."]
        )

        assertWarningsPresent(
            self, "comments_warning.zs", ["unused_field_comments.zs:61:45: Documentation comment is not used."]
        )
    ...
    def testUnusedStructCommentMultipleComments(self):
        assertWarningsPresent(
            self,
            "comments_warning.zs",
            ["unused_struct_comment_multiple_comments.zs:5:9: Documentation comment is not used."],
        )
