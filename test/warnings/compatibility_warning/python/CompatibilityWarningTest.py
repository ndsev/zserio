...
class CompatibilityWarningTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        cls.warnings = {}
        getZserioApi(__file__, "compatibility_warning/root_with_diff_compatibility_warning.zs",
                     expectedWarnings=1, errorOutputDict=cls.warnings,
                     extraArgs=["-withoutCrossExtensionCheck"])
        getZserioApi(__file__, "compatibility_warning/root_without_compatibility_warning.zs",
                     expectedWarnings=1, errorOutputDict=cls.warnings,
                     extraArgs=["-withoutCrossExtensionCheck"])
